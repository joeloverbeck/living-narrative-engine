...
- Maintain paired-state components like `sex-states:being_fucked_vaginally` and `sex-states:fucking_vaginally` that coordinate penetrative experiences.
...
All assets within this module use the **Mystic Purple** visual identity documented in [`docs/mods/mod-color-schemes.md`](../../../docs/mods/mod-color-schemes.md), keeping shared sexual systems visually consistent.
