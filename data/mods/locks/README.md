...
- Rule handlers flip `locks:openable.isLocked`, validate the actor still holds the matching key, emit perceptible events, and end the turn on success or clear failures.
