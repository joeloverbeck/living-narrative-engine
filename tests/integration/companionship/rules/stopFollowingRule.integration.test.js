...
describe('stop_following rule integration', () => {
  ...
  beforeEach(() => {
    ...
    const dataRegistry = {
      ...
      getConditionDefinition: jest.fn((id) => {
        if (id === 'companionship:event-is-action-stop-following')
  ...
  it('removes following relationship and emits perceptible event when co-located', async () => {
    ...
    const entities = [
      {
        id: 'f1',
        components: {
          'companionship:following': { leaderId: 'l1' },
      ...
      },
      {
        id: 'l1',
        components: {
          'companionship:leading': { followers: ['f1'] },
          'core:position': { locationId: 'loc1' },
        },
      },
      { id: 'loc1', components: {} },
    ...
    await testEnv.eventBus.dispatch(ATTEMPT_ACTION_ID, {
      ...
      actorId: 'f1',
      actionId: 'companionship:stop_following',
