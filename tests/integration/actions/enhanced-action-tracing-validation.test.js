...
describe('Enhanced Action Tracing Validation', () => {
  ...
  it('should handle clothing resolution for scenario with only accessories', () => {
    ...
    // Assert - Check that accessories are properly excluded
  ...
  it('should handle successful clothing resolution for scenario with base layer', () => {
