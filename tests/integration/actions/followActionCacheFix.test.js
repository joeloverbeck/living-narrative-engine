...
// ScopeEngine and SimpleEntityManager imports removed because the test uses
// mocked implementations instead.
...
describe('Follow Action Cache Fix - Component State in Cache Key', () => {
  ...
  it('should generate different cache keys when following/leading components change', () => {
    ...
    const key3 = scopeCache._generateKey(
      actor1WithDifferentFollowers.id,
      ast,
      runtimeCtx,
      actor1WithDifferentFollowers
    );
    ...
    const key4 = scopeCache._generateKey(
      actor1Following.id,
      ast,
      runtimeCtx,
      actor1Following
  ...
  it('should generate stable keys for the same component state', () => {
    ...
    const actor1 = {
      ...
      components: {
        [LEADING_COMPONENT_ID]: {
          followers: ['follower2', 'follower1', 'follower3'],
        },
      },
    };
    ...
    const actor2 = {
      ...
      components: {
        [LEADING_COMPONENT_ID]: {
          followers: ['follower3', 'follower1', 'follower2'],
        },
      },
    };
