...
describe('Anatomy Orientation Propagation Integration Tests', () => {
  ...
  describe('Socket Orientation Propagation', () => {
    it('should propagate orientation from parent socket to child anatomy:part component', async () => {
      ...
      const torsoEntity = entityManager.getEntityInstance(anatomyData.body.root);
      ...
      const leftArmSocket = torsoSockets.sockets.find(s => s.id === 'left_shoulder');
      const rightArmSocket = torsoSockets.sockets.find(s => s.id === 'right_shoulder');
      const leftLegSocket = torsoSockets.sockets.find(s => s.id === 'left_hip');
      const rightLegSocket = torsoSockets.sockets.find(s => s.id === 'right_hip');
    ...
    it('should propagate orientation down the hierarchy (arm → hand)', async () => {
      ...
      const leftWristSocket = leftArmSockets.sockets.find(s => s.id === 'wrist');
      const rightWristSocket = rightArmSockets.sockets.find(s => s.id === 'wrist');
    ...
    it('should propagate orientation down the hierarchy (leg → foot)', async () => {
      ...
      const leftAnkleSocket = leftLegSockets.sockets.find(s => s.id === 'ankle');
      const rightAnkleSocket = rightLegSockets.sockets.find(s => s.id === 'ankle');
