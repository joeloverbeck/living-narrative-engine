/**
 * @file Integration test for bending:bend_over lying_down forbidden component.
...
describe('bending:bend_over - lying_down forbidden component', () => {
  let testFixture;
  ...
  it('should NOT discover action when actor is lying down', () => {
    ...
    expect(actionIds).not.toContain('bending:bend_over');
  });
});
