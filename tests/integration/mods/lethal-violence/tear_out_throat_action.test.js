/**
 * @file Integration tests for the lethal-violence:tear_out_throat action using mod test infrastructure.
...
import tearOutThroatRule from '../../../../data/mods/lethal-violence/rules/handle_tear_out_throat.rule.json';
import eventIsActionTearOutThroat from '../../../../data/mods/lethal-violence/conditions/event-is-action-tear-out-throat.condition.json';

describe('Lethal Violence Mod: Tear Out Throat Action Integration', () => {
  let testFixture;
  ...
  describe('Rule Isolation', () => {
    it('only responds to lethal-violence:tear_out_throat action', async () => {
      const scenario = testFixture.createStandardActorTarget(['Alice', 'Bob']);
