/**
 * @file Integration tests for lethal-violence:tear_out_throat action discovery.
...
import tearOutThroatAction from '../../../../data/mods/lethal-violence/actions/tear_out_throat.action.json';

const ACTION_ID = 'lethal-violence:tear_out_throat';

describe('lethal-violence:tear_out_throat action discovery', () => {
  let testFixture;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction('lethal-violence', ACTION_ID);
  ...
  describe('Action structure validation', () => {
    it('matches the expected lethal-violence action schema', () => {
    ...
    it('uses lethal-violence visual scheme', () => {
