...
describe('Mouth Engagement - Edge Cases', () => {
  ...
  describe('Entity Edge Cases', () => {
    it('should handle entity without anatomy gracefully', async () => {
      ...
      await entityManager.addComponent(entityId, NAME_COMPONENT_ID, { text: 'Basic Entity' });
    ...
    it('should handle entity with malformed anatomy', async () => {
      ...
      await entityManager.createEntity(entityId);
      await entityManager.addComponent(entityId, NAME_COMPONENT_ID, { text: 'Malformed Entity' });
    ...
    it('should handle entity with multiple mouth parts', async () => {
      ...
      await entityManager.addComponent(actorId, NAME_COMPONENT_ID, { text: 'Multi-Mouth Actor' });
      ...
      await entityManager.addComponent(mouth1Id, 'anatomy:part', { subType: 'mouth' });
      ...
      await entityManager.addComponent(mouth2Id, 'anatomy:part', { subType: 'mouth' });
      ...
      const mouth1Engagement = entityManager.getComponentData(mouth1Id, 'core:mouth_engagement');
  ...
  describe('Component Edge Cases', () => {
    ...
    it('should handle missing mouth engagement component gracefully', async () => {
      ...
      await entityManager.createEntity(actorId);
      await entityManager.addComponent(actorId, NAME_COMPONENT_ID, { text: 'No Engagement Actor' });
