/**
 * @file Integration tests for hand_holding:let_go_of_hand action discovery.
...
const ACTION_ID = 'hand_holding:let_go_of_hand';

describe('hand_holding:let_go_of_hand action discovery', () => {
  let testFixture;
      ...
      scopeResolver.resolveSync = (scopeName, context) => {
        if (
          ...
          const holdingComponent =
            actorEntity.components?.['hand_holding:holding_hand'];
  ...
  describe('Action discovery scenarios', () => {
    ...
    it('is removed from discovery once the components are cleared', () => {
      ...
      delete scenario.actor.components['hand_holding:holding_hand'];
      delete scenario.target.components['hand_holding:hand_held'];
      testFixture.reset([room, scenario.actor, scenario.target]);
      configureActionDiscovery();
