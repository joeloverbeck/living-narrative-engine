/**
 * @file Integration tests for the hand_holding:warm_hands_between_yours action and rule.
...
import handleWarmHandsRule from '../../../../data/mods/hand_holding/rules/handle_warm_hands_between_yours.rule.json';
import eventIsActionWarmHands from '../../../../data/mods/hand_holding/conditions/event-is-action-warm-hands-between-yours.condition.json';

const ACTION_ID = 'hand_holding:warm_hands_between_yours';

describe('hand_holding:warm_hands_between_yours action integration', () => {
  let testFixture;
