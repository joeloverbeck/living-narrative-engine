/**
 * @file Integration tests for hand_holding:withdraw_hand_from_grasp action discovery.
...
const ACTION_ID = 'hand_holding:withdraw_hand_from_grasp';

describe('hand_holding:withdraw_hand_from_grasp action discovery', () => {
  let testFixture;
  ...
  describe('Action structure validation', () => {
    it('matches the expected withdraw_hand_from_grasp action schema', () => {
      ...
      expect(withdrawAction.targets).toBe(
        'hand_holding:actor_whose_hand_target_is_holding'
      );
  ...
  describe('Action discovery scenarios', () => {
    ...
    it('disappears when the actor is no longer marked as hand_held', () => {
      ...
      delete scenario.actor.components['hand_holding:hand_held'];
      testFixture.reset([room, scenario.actor, scenario.target]);
      configureActionDiscovery();
    ...
    it('is hidden from other close actors who are not part of the linkage', () => {
      ...
      thirdActor.actor.components['hand_holding:holding_hand'] = {
        held_entity_id: thirdActor.target.id,
        initiated: true,
      };
      thirdActor.target.components['hand_holding:hand_held'] = {
