...
import drinkFromAction from '../../../../data/mods/items/actions/drink_from.action.json';
...
describe('items:drink_from prerequisites', () => {
  ...
  describe('action definition structure', () => {
    ...
    test('should reference anatomy:actor-has-free-grabbing-appendage condition', () => {
      expect(drinkFromAction.prerequisites.length).toBeGreaterThan(0);
      const prerequisite = drinkFromAction.prerequisites[0];
