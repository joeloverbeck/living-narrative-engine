/**
 * @file Integration tests for affection-embracing:link_arms action discovery.
...
describe('affection-embracing:link_arms action discovery', () => {
  let testFixture;
  ...
  describe('Action structure validation', () => {
    ...
    it('requires actor closeness and uses the affection-embracing color palette', () => {
