/**
 * @file Integration tests verifying wrap_arm_around_waist action is forbidden when actor is straddling
 * @description Tests anatomical constraint that prevents wrapping arm around target's waist when sitting on it
 */

import { describe, it, beforeEach, afterEach, expect } from '@jest/globals';
import { ModTestFixture } from '../../../common/mods/ModTestFixture.js';
import { ModEntityBuilder } from '../../../common/mods/ModEntityBuilder.js';
import wrapArmAction from '../../../../data/mods/affection-embracing/actions/wrap_arm_around_waist.action.json';

const ACTION_ID = 'affection-embracing:wrap_arm_around_waist';

describe('wrap_arm_around_waist forbidden when straddling - Integration Tests', () => {
  let testFixture;
  let configureActionDiscovery;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction('affection-embracing', ACTION_ID);
    ...
    configureActionDiscovery = () => {
      ...
      testEnv.actionIndex.buildIndex([wrapArmAction]);
      ...
      scopeResolver.resolveSync = (scopeName, context) => {
        if (scopeName === 'affection-embracing:close_actors_facing_each_other') {
