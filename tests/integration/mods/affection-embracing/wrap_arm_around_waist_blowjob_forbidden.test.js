/**
 * @file Integration tests verifying affection-embracing:wrap_arm_around_waist is forbidden when target has giving_blowjob component.
...
describe('affection-embracing:wrap_arm_around_waist - giving_blowjob forbidden component', () => {
  let testFixture;
