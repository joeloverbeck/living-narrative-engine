/**
 * @file Integration tests for the affection-embracing:place_hand_on_waist action and rule.
...
import placeHandOnWaistRule from '../../../../data/mods/affection-embracing/rules/place_hand_on_waist.rule.json';
import eventIsActionPlaceHandOnWaist from '../../../../data/mods/affection-embracing/conditions/event-is-action-place-hand-on-waist.condition.json';

describe('affection-embracing:place_hand_on_waist action integration', () => {
  let testFixture;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction(
      'affection-embracing',
      'affection-embracing:place_hand_on_waist',
