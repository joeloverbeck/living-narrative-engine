/**
 * @file Integration tests verifying affection-embracing:sling_arm_around_shoulders is forbidden when target has giving_blowjob component.
...
const ACTION_ID = 'affection-embracing:sling_arm_around_shoulders';

describe('affection-embracing:sling_arm_around_shoulders - giving_blowjob forbidden component', () => {
  let testFixture;
