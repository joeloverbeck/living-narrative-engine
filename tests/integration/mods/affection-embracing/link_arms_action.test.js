/**
 * @file Integration tests for the affection-embracing:link_arms action and rule.
...
import handleLinkArmsRule from '../../../../data/mods/affection-embracing/rules/handle_link_arms.rule.json';
import eventIsActionLinkArms from '../../../../data/mods/affection-embracing/conditions/event-is-action-link-arms.condition.json';

const ACTION_ID = 'affection-embracing:link_arms';

describe('affection-embracing:link_arms action integration', () => {
  let testFixture;
