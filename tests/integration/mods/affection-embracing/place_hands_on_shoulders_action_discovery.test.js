/**
 * @file Integration tests for affection-embracing:place_hands_on_shoulders action discovery.
...
describe('affection-embracing:place_hands_on_shoulders action discovery', () => {
  let testFixture;
  ...
  describe('Action structure validation', () => {
    it('matches the expected affection-embracing action schema', () => {
    ...
    it('requires actor closeness, no forbidden components, and uses the affection-embracing color palette', () => {
