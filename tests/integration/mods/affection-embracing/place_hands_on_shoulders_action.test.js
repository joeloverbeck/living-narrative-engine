/**
 * @file Integration tests for the affection-embracing:place_hands_on_shoulders action and rule.
...
import placeHandsOnShouldersRule from '../../../../data/mods/affection-embracing/rules/place_hands_on_shoulders.rule.json';
import eventIsActionPlaceHandsOnShoulders from '../../../../data/mods/affection-embracing/conditions/event-is-action-place-hands-on-shoulders.condition.json';

const ACTION_ID = 'affection-embracing:place_hands_on_shoulders';
const EXPECTED_SENTENCE = "{actor} places their hands on {target}'s shoulders.";

describe('affection-embracing:place_hands_on_shoulders action integration', () => {
  let testFixture;
  ...
  it('does not fire when a different action is attempted', async () => {
    ...
    await testFixture.eventBus.dispatch('core:attempt_action', {
      ...
      actorId: scenario.actor.id,
      actionId: 'affection-embracing:place_hand_on_waist',
      targetId: scenario.target.id,
