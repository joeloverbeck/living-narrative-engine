/**
 * @file Integration tests for sex-penile-oral:lick_testicles_sitting_close action discovery.
 * @description Validates the seated testicle licking action availability for close partners with at least one uncovered testicle.
 */
...
/**
 * @description Registers the seated testicle licking action for discovery.
...
describe('sex-penile-oral:lick_testicles_sitting_close action discovery', () => {
  let testFixture;
