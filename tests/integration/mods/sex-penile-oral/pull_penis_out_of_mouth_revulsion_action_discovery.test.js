 ...
 *
 * @param {object} options - Configuration options for scenario.
 * @param {boolean} [options.includeGivingBlowjob] - Include giving_blowjob component.
 * @param {boolean} [options.includeCloseness] - Include closeness component.
 * @param {boolean} [options.mismatchedReferences] - Use mismatched entity references.
 * @param {boolean} [options.targetHasReceivingBlowjob] - Target has receiving_blowjob component.
