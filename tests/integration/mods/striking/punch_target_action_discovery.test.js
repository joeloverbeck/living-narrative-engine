/**
 * @file Integration tests for striking:punch_target action discovery
...
import punchTargetAction from '../../../../data/mods/striking/actions/punch_target.action.json';
import { ActionResult } from '../../../../src/actions/core/actionResult.js';
import { ActionTargetContext } from '../../../../src/models/actionTargetContext.js';
import SimpleEntityManager from '../../../common/entities/simpleEntityManager.js';

const ACTION_ID = 'striking:punch_target';

describe('striking:punch_target action discovery', () => {
  let testBed;
  ...
  describe('Action structure validation', () => {
    ...
    it('has striking mod visual styling', () => {
      ...
      expect(punchTargetAction.visual.backgroundColor).toBe('#c62828');
