...
import handleScootCloserRightRule from '../../../../data/mods/positioning/rules/handle_scoot_closer_right.rule.json' assert { type: 'json' };
import eventIsActionScootCloserRight from '../../../../data/mods/positioning/conditions/event-is-action-scoot-closer-right.condition.json' assert { type: 'json' };
import scootCloserRightAction from '../../../../data/mods/positioning/actions/scoot_closer_right.action.json' assert { type: 'json' };
...
describe('scoot_closer_right action discovery - Integration Tests', () => {
  ...
  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction(
      'positioning',
      'positioning:scoot_closer_right',
  ...
  describe('Valid discovery scenarios', () => {
    it('should discover scoot_closer_right when an actor can move right toward an occupant', async () => {
      ...
      const scootAction = actions.find(
        (action) => action.id === 'positioning:scoot_closer_right'
      );
