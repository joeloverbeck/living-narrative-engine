...
import straddleFacingAwayRule from '../../../../data/mods/positioning/rules/straddle_waist_facing_away.rule.json' assert { type: 'json' };
import eventIsActionStraddleFacingAway from '../../../../data/mods/positioning/conditions/event-is-action-straddle-waist-facing-away.condition.json' assert { type: 'json' };
import straddleFacingAwayAction from '../../../../data/mods/positioning/actions/straddle_waist_facing_away.action.json' assert { type: 'json' };
...
describe('straddle_waist_facing_away action discovery - Integration Tests', () => {
  ...
  describe('Distinction from straddle_waist_facing', () => {
    it('should be a separate action from straddle_waist_facing', async () => {
      ...
      expect(straddleFacingAway.id).toBe('positioning:straddle_waist_facing_away');
