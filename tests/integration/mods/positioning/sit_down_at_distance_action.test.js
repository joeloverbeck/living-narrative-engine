/**
 * @file Integration tests for positioning:sit_down_at_distance rule execution.
...
import handleSitDownAtDistanceRule from '../../../../data/mods/positioning/rules/handle_sit_down_at_distance.rule.json' assert { type: 'json' };
import eventIsActionSitDownAtDistance from '../../../../data/mods/positioning/conditions/event-is-action-sit-down-at-distance.condition.json' assert { type: 'json' };
...
describe('positioning:sit_down_at_distance action integration', () => {
  let testFixture;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction(
      'positioning',
      'positioning:sit_down_at_distance',
