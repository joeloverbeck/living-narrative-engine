/**
 * @file Integration tests for positioning:get_close forbidden components validation.
...
import getCloseAction from '../../../../data/mods/positioning/actions/get_close.action.json' assert { type: 'json' };

describe('positioning:get_close - Forbidden components validation', () => {
  let testFixture;
  ...
  describe('positioning:wielding forbidden component', () => {
    it('should NOT appear when actor has wielding component', () => {
      ...
      expect(actionIds).not.toContain('positioning:get_close');
    });
