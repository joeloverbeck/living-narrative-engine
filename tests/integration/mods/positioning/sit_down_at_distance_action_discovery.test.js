/**
 * @file Integration tests for positioning:sit_down_at_distance action discovery.
...
import sitDownAtDistanceAction from '../../../../data/mods/positioning/actions/sit_down_at_distance.action.json' assert { type: 'json' };
import sitDownAction from '../../../../data/mods/positioning/actions/sit_down.action.json' assert { type: 'json' };

describe('positioning:sit_down_at_distance action discovery', () => {
  let testFixture;
  ...
  beforeEach(async () => {
    ...
    // Add custom scope resolver for positioning:actors_sitting_with_space_to_right
  ...
  describe('Action metadata validation', () => {
    it('should have correct action structure', () => {
      ...
      expect(sitDownAtDistanceAction.id).toBe('positioning:sit_down_at_distance');
  ...
  describe('Positive discoverability scenarios', () => {
    it('should discover action when valid configuration exists (rightmost with 2 spaces)', () => {
      ...
      const sitAtDistanceActions = actions.filter(
        (a) => a.id === 'positioning:sit_down_at_distance'
      );
    ...
    it('should coexist with legacy sit_down action when appropriate', () => {
      ...
      expect(actionIds).toContain('positioning:sit_down_at_distance');
