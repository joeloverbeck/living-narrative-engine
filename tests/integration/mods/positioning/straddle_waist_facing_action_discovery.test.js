...
import straddleFacingRule from '../../../../data/mods/positioning/rules/straddle_waist_facing.rule.json' assert { type: 'json' };
import eventIsActionStraddleFacing from '../../../../data/mods/positioning/conditions/event-is-action-straddle-waist-facing.condition.json' assert { type: 'json' };
import straddleFacingAction from '../../../../data/mods/positioning/actions/straddle_waist_facing.action.json' assert { type: 'json' };
