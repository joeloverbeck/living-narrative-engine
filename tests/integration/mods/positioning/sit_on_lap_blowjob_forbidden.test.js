...
import sitOnLapFacingAction from '../../../../data/mods/positioning/actions/sit_on_lap_from_sitting_facing.action.json';
import sitOnLapFacingAwayAction from '../../../../data/mods/positioning/actions/sit_on_lap_from_sitting_facing_away.action.json';
...
describe('sit_on_lap actions - giving_blowjob forbidden component', () => {
  ...
  describe('sit_on_lap_from_sitting_facing', () => {
    const ACTION_ID = 'positioning:sit_on_lap_from_sitting_facing';
  ...
  describe('sit_on_lap_from_sitting_facing_away', () => {
    const ACTION_ID = 'positioning:sit_on_lap_from_sitting_facing_away';
