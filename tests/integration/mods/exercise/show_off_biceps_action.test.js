...
describe('Exercise Mod: Show Off Biceps Action', () => {
  describe('Action Properties', () => {
    ...
    it('should have proper schema reference', () => {
      ...
      expect(showOffBicepsAction.$schema).toBe('schema://living-narrative-engine/action.schema.json');
    });
  });
  ...
  describe('Schema Validation', () => {
    it('should have all required action properties', () => {
      ...
      const requiredProps = ['$schema', 'id', 'name', 'description', 'targets', 'template', 'visual'];
