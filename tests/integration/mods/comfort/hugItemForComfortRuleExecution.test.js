/**
 * @file Integration tests for the comfort:hug_item_for_comfort rule.
...
import hugItemForComfortRule from '../../../../data/mods/comfort/rules/handle_hug_item_for_comfort.rule.json' assert { type: 'json' };
import eventIsActionHugItemForComfort from '../../../../data/mods/comfort/conditions/event-is-action-hug-item-for-comfort.condition.json' assert { type: 'json' };

const ACTION_ID = 'comfort:hug_item_for_comfort';

describe('comfort:hug_item_for_comfort rule execution', () => {
  let testFixture;
