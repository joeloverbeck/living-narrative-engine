/**
 * @file Integration tests for the comfort:hug_item_for_comfort action definition.
...
import hugItemForComfortAction from '../../../../data/mods/comfort/actions/hug_item_for_comfort.action.json' assert { type: 'json' };

const ACTION_ID = 'comfort:hug_item_for_comfort';

describe('comfort:hug_item_for_comfort action definition', () => {
  let testFixture;
  let configureActionDiscovery;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction('comfort', ACTION_ID);
  ...
  describe('Action Structure Validation', () => {
    it('should have correct action structure', () => {
      ...
      expect(hugItemForComfortAction.id).toBe('comfort:hug_item_for_comfort');
  ...
  describe('Action discovery behavior', () => {
    it('should appear when actor inventory contains a comfort item', () => {
      ...
      const plushToy = new ModEntityBuilder('plush_toy_inventory')
        ...
        .withComponent('comfort:allows_soothing_hug', {})
        .build();
