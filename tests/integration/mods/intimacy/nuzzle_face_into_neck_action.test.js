...
describe('intimacy:nuzzle_face_into_neck action integration', () => {
  ...
  it('successfully executes nuzzle face into neck action between close actors', async () => {
    ...
    testFixture.assertActionSuccess("Alice nuzzles their face into Bob's neck.");
  });
  ...
  it('handles multiple close partners correctly', async () => {
    ...
    expect(perceptibleEvent1.payload.descriptionText).toBe("Alice nuzzles their face into Bob's neck.");
    ...
    expect(perceptibleEvent2.payload.descriptionText).toBe("Alice nuzzles their face into Charlie's neck.");
  });
  ...
  it('generates proper perceptible event for observers', async () => {
    ...
    expect(perceptibleEvent.payload.descriptionText).toBe("Elena nuzzles their face into Marcus's neck.");
