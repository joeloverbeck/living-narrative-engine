/**
 * @file Integration tests for the intimacy:hold_hand action and rule.
 * @description Tests the rule execution after the hold_hand action is performed.
 */

import { describe, it, beforeEach, afterEach, expect } from '@jest/globals';
import { ModTestFixture } from '../../../common/mods/ModTestFixture.js';
import holdHandRule from '../../../../data/mods/intimacy/rules/handle_hold_hand.rule.json';
import eventIsActionHoldHand from '../../../../data/mods/intimacy/conditions/event-is-action-hold-hand.condition.json';

describe('intimacy:hold_hand action integration', () => {
  let testFixture;
