...
import straddleFacingRule from '../../../../data/mods/straddling/rules/straddle_waist_facing.rule.json' assert { type: 'json' };
import eventIsActionStraddleFacing from '../../../../data/mods/straddling/conditions/event-is-action-straddle-waist-facing.condition.json' assert { type: 'json' };
import straddleFacingAction from '../../../../data/mods/straddling/actions/straddle_waist_facing.action.json' assert { type: 'json' };

describe('straddle_waist_facing action discovery - Integration Tests', () => {
  let testFixture;
  ...
  beforeEach(async () => {
    ...
    configureActionDiscovery = () => {
      ...
      // Build the action index with the straddle_waist_facing action
  ...
  describe('Valid Discovery Scenarios', () => {
    it('should discover action when actor is close to sitting target', async () => {
      ...
      console.log(
        '  Target sitting_on:',
        targetEntity.components['sitting-states:sitting_on']
      );
