...
import sitOnLapFacingAwayAction from '../../../../data/mods/straddling/actions/sit_on_lap_from_sitting_facing_away.action.json' assert { type: 'json' };
  ...
  describe('Valid Discovery Scenarios', () => {
    it('should discover action when both actor and target are sitting and close', async () => {
      ...
      const sitOnLapAction = actions.find(
        (a) => a.id === 'straddling:sit_on_lap_from_sitting_facing_away'
      );
