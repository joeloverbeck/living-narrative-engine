...
import liftOntoLapAction from '../../../../data/mods/straddling/actions/lift_onto_lap_facing_away.action.json' assert { type: 'json' };
  ...
  describe('Valid Discovery Scenarios', () => {
    it('should discover action when both actor and target are sitting and close', async () => {
      ...
      const liftAction = actions.find(
        (a) => a.id === 'straddling:lift_onto_lap_facing_away'
      );
