...
import liftOntoLapFaceToFaceAction from '../../../../data/mods/straddling/actions/lift_onto_lap_face_to_face.action.json';
import liftOntoLapFacingAwayAction from '../../../../data/mods/straddling/actions/lift_onto_lap_facing_away.action.json';
...
describe('lift_onto_lap actions - giving_blowjob forbidden component', () => {
  ...
  describe('lift_onto_lap_face_to_face', () => {
    const ACTION_ID = 'straddling:lift_onto_lap_face_to_face';
  ...
  describe('lift_onto_lap_facing_away', () => {
    const ACTION_ID = 'straddling:lift_onto_lap_facing_away';
