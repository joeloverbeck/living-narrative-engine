/**
 * @file Integration tests for hugging:release_self_from_hug_forceful action discovery.
 * @description Ensures the forceful self-release action is discoverable only when the actor is being hugged by the target.
 */
...
const ACTION_ID = 'hugging:release_self_from_hug_forceful';

describe('hugging:release_self_from_hug_forceful action discovery', () => {
  let testFixture;
  ...
  it('disappears from discovery after the forceful self-release action resolves', async () => {
