/**
 * @file Integration tests for lying:get_up_from_lying action discovery.
...
describe('lying:get_up_from_lying action discovery', () => {
  describe('Action structure validation', () => {
    it('should have correct action structure', () => {
      expect(getUpFromLyingAction).toBeDefined();
      expect(getUpFromLyingAction.id).toBe('lying:get_up_from_lying');
    ...
    it('should have correct visual styling matching lying actions (Deep Blue)', () => {
      ...
      expect(getUpFromLyingAction.visual.backgroundColor).toBe('#0d47a1');
      expect(getUpFromLyingAction.visual.textColor).toBe('#bbdefb');
      expect(getUpFromLyingAction.visual.hoverBackgroundColor).toBe('#1565c0');
      expect(getUpFromLyingAction.visual.hoverTextColor).toBe('#e3f2fd');
    });
