 ...
 * @file Integration tests for item-transfer:give_item action lighting prerequisite
 * @description Tests that the give_item action correctly requires the actor's location to be lit
 *
...
describe('item-transfer:give_item lighting prerequisite', () => {
  ...
  describe('action definition structure', () => {
    ...
    test('should have lighting prerequisite using isActorLocationLit operator', () => {
      const lightingPrereq = giveItemAction.prerequisites.find(
    ...
    test('should have failure_message for lighting prerequisite', () => {
      ...
      expect(lightingPrereq.failure_message).toBe(
        'It is too dark to give an item.'
      );
    });
  ...
  describe('prerequisite evaluation - pass cases', () => {
    test('should pass when location is naturally lit', () => {
      ...
      const lightingPrereq = giveItemAction.prerequisites.filter(
        (prereq) => prereq.logic?.isActorLocationLit
      );
