/**
 * @file Integration tests verifying kissing:nibble_earlobe_playfully is forbidden when actor has giving_blowjob component.
...
const ACTION_ID = 'kissing:nibble_earlobe_playfully';

describe('kissing:nibble_earlobe_playfully - giving_blowjob forbidden component', () => {
  let testFixture;
  ...
  beforeEach(async () => {
    ...
    configureActionDiscovery = () => {
      ...
      testEnv.actionIndex.buildIndex([nibbleEarlobePlayfullyAction]);

      const scopeResolver = testEnv.unifiedScopeResolver;
      const originalResolve =
        scopeResolver.__nibbleEarlobeOriginalResolve ||
        scopeResolver.resolveSync.bind(scopeResolver);

      scopeResolver.__nibbleEarlobeOriginalResolve = originalResolve;
  ...
  describe('Baseline: Action available without giving_blowjob', () => {
    it('should be available when actor does NOT have giving_blowjob component', () => {
      const scenario = testFixture.createCloseActors(['George', 'Hannah']);
      configureActionDiscovery();
