/**
 * @file Integration tests for quickly_wield_weapon action discovery
 * Tests action structure, scope configuration, and discoverability
 */

import { describe, it, expect } from '@jest/globals';
import actionJson from '../../../../data/mods/weapons/actions/quickly_wield_weapon.action.json' assert { type: 'json' };

describe('quickly_wield_weapon action definition', () => {
  describe('Action Structure', () => {
    ...
    it('should have correct name', () => {
      expect(actionJson.name).toBe('Quickly Wield Weapon');
    });
  ...
  describe('Prerequisites', () => {
    it('should have prerequisites defined', () => {
      expect(actionJson.prerequisites).toBeDefined();
      expect(actionJson.prerequisites).toBeInstanceOf(Array);
      expect(actionJson.prerequisites.length).toBeGreaterThan(0);
    });
    ...
    it('should have failure message for missing appendage', () => {
      ...
      expect(prerequisite.failure_message).toContain('hand');
    });
  });
