...
describe('clothing:inventory_wearables scope', () => {
  it('uses inventory:inventory with clothing:wearable filter and no core inventory fallback', async () => {
    ...
    expect(scopeContent).toContain('actor.components.inventory:inventory.items');
