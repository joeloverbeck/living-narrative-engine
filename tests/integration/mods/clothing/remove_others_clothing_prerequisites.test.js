...
describe('clothing:remove_others_clothing prerequisites', () => {
  ...
  describe('action definition structure', () => {
    test('should have prerequisites array defined', () => {
      expect(removeOthersClothingAction.prerequisites).toBeDefined();
      expect(Array.isArray(removeOthersClothingAction.prerequisites)).toBe(
        true
      );
    });

    test('should reference anatomy:actor-has-two-free-grabbing-appendages condition', () => {
      expect(removeOthersClothingAction.prerequisites.length).toBeGreaterThan(
        0
      );
      const prerequisite = removeOthersClothingAction.prerequisites[0];
    ...
    test('should preserve other action properties', () => {
      ...
      expect(removeOthersClothingAction.generateCombinations).toBe(true);
    });
  });
  ...
  describe('prerequisite evaluation - two free grabbing appendages available', () => {
    test('should pass when actor has exactly two free grabbing appendages', () => {
      ...
      const result = prerequisiteService.evaluate(
        removeOthersClothingAction.prerequisites,
        removeOthersClothingAction,
        actor
      );
