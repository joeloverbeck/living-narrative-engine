/**
 * @file Integration tests for the sex-dry-intimacy:rub_vagina_over_clothes action and rule.
...
describe('sex-dry-intimacy:rub_vagina_over_clothes action integration', () => {
  let testFixture;
  ...
  it('handles missing target gracefully', async () => {
    ...
    await expect(async () => {
      await testFixture.eventBus.dispatch('core:attempt_action', {
        actionId: 'sex-dry-intimacy:rub_vagina_over_clothes',
        actorId: 'alice',
