/**
 * @file Integration tests for violence:slap_target action discovery
...
import slapTargetAction from '../../../../data/mods/violence/actions/slap_target.action.json';
import { ActionResult } from '../../../../src/actions/core/actionResult.js';
import { ActionTargetContext } from '../../../../src/models/actionTargetContext.js';
import SimpleEntityManager from '../../../common/entities/simpleEntityManager.js';

const ACTION_ID = 'violence:slap_target';

describe('violence:slap_target action discovery', () => {
  let testBed;
  ...
  describe('Action structure validation', () => {
    ...
    it('has violence mod visual styling', () => {
      ...
      expect(slapTargetAction.visual.backgroundColor).toBe('#8b0000');
