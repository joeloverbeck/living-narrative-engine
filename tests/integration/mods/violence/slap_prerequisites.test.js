...
describe('violence:slap prerequisites', () => {
  ...
  describe('action definition structure', () => {
    ...
    test('should reference anatomy:actor-has-free-grabbing-appendage condition', () => {
      expect(slapAction.prerequisites.length).toBeGreaterThan(0);
      const prerequisite = slapAction.prerequisites[0];
