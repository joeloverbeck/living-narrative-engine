/**
 * @file Integration tests for the comfort-items:hug_item_for_comfort rule.
...
import hugItemForComfortRule from '../../../../data/mods/comfort-items/rules/handle_hug_item_for_comfort.rule.json' assert { type: 'json' };
import eventIsActionHugItemForComfort from '../../../../data/mods/comfort-items/conditions/event-is-action-hug-item-for-comfort.condition.json' assert { type: 'json' };

const ACTION_ID = 'comfort-items:hug_item_for_comfort';

describe('comfort-items:hug_item_for_comfort rule execution', () => {
  let testFixture;
