/**
 * @file Integration tests for the comfort-items:hug_item_for_comfort action definition.
...
import hugItemForComfortAction from '../../../../data/mods/comfort-items/actions/hug_item_for_comfort.action.json' assert { type: 'json' };

const ACTION_ID = 'comfort-items:hug_item_for_comfort';

describe('comfort-items:hug_item_for_comfort action definition', () => {
  let testFixture;
  let configureActionDiscovery;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction('comfort-items', ACTION_ID);

    // Register inventory scopes needed for hug_item_for_comfort action discovery
  ...
  describe('Action Structure Validation', () => {
    it('should have correct action structure', () => {
      ...
      expect(hugItemForComfortAction.id).toBe('comfort-items:hug_item_for_comfort');
    ...
    it('should require item and allows_soothing_hug components on primary target', () => {
      ...
      expect(hugItemForComfortAction.required_components.primary).toEqual([
        'items-core:item',
        'comfort-items:allows_soothing_hug',
      ]);
    });
  ...
  describe('Action discovery behavior', () => {
    it('should appear when actor inventory contains a comfort item', () => {
      ...
      const plushToy = new ModEntityBuilder('plush_toy_inventory')
        ...
        .withComponent('comfort-items:allows_soothing_hug', {})
        .build();
