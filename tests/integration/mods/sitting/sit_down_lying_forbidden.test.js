/**
 * @file Integration test for sitting:sit_down lying_down forbidden component.
...
describe('sitting:sit_down - lying_down forbidden component', () => {
  let testFixture;
  ...
  it('should NOT discover action when actor is lying down', () => {
    ...
    expect(actionIds).not.toContain('sitting:sit_down');
  });
});
