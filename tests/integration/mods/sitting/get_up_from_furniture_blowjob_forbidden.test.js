/**
 * @file Integration tests verifying sitting:get_up_from_furniture is forbidden when actor has giving_blowjob component.
...
import getUpFromFurnitureAction from '../../../../data/mods/sitting/actions/get_up_from_furniture.action.json';

const ACTION_ID = 'sitting:get_up_from_furniture';

describe('sitting:get_up_from_furniture - giving_blowjob forbidden component', () => {
  let testFixture;
  let configureActionDiscovery;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction('sitting', ACTION_ID);
