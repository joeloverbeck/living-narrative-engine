/**
 * @file Integration tests for the sex-penile-manual:fondle_penis action and rule.
...
describe('sex-penile-manual:fondle_penis action integration', () => {
  let testFixture;
  ...
  it('handles missing target gracefully', async () => {
    ...
    await expect(async () => {
      await testFixture.eventBus.dispatch('core:attempt_action', {
        actionId: 'sex-penile-manual:fondle_penis',
        actorId: 'alice',
