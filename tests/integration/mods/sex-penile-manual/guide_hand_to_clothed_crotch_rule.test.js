/**
 * @file Integration tests for the sex-penile-manual:guide_hand_to_clothed_crotch rule execution.
...
describe('sex-penile-manual:guide_hand_to_clothed_crotch rule', () => {
  let testFixture;
  ...
  it('includes the success macro in the rule definition', () => {
    ...
    expect(testFixture.conditionFile.id).toBe(
      'sex-penile-manual:event-is-action-guide-hand-to-clothed-crotch'
    );
