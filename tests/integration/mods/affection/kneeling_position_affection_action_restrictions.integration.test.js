...
describe('Kneeling Position Affection Action Restrictions', () => {
  ...
  beforeEach(async () => {
    ...
    const scopePaths = [
      ...
      'data/mods/personal-space-states/scopes/close_actors.scope',
      'data/mods/affection/scopes/close_actors_facing_each_other.scope',
      'data/mods/personal-space-states/scopes/close_actors_or_entity_kneeling_before_actor.scope',
  ...
  describe('Hug Tight Action (personal-space-states:close_actors_facing_each_other_or_behind_target)', () => {
  ...
  describe('Link Arms Action (personal-space-states:close_actors_facing_each_other_or_behind_target)', () => {
    it('should NOT be available when target is kneeling before actor', async () => {
      actor1 = createActor('test:actor1', 'Alice');
      actor2 = createActor('test:actor2', 'Bob');
      establishCloseness(actor1, actor2);
  ...
  describe('Place Hand on Waist Action (personal-space-states:close_actors)', () => {
    it('should NOT be available when target is kneeling before actor', async () => {
      actor1 = createActor('test:actor1', 'Alice');
      actor2 = createActor('test:actor2', 'Bob');
      establishCloseness(actor1, actor2);
  ...
  describe('Rest Head on Shoulder Action (personal-space-states:close_actors_facing_each_other_or_behind_target)', () => {
    it('should NOT be available when target is kneeling before actor', async () => {
      actor1 = createActor('test:actor1', 'Alice');
      actor2 = createActor('test:actor2', 'Bob');
      establishCloseness(actor1, actor2);
