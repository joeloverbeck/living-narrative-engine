/**
 * @file Integration tests for affection:rest_head_against_flat_chest action discovery.
 * @description Ensures the flat-chested variant is discoverable for close, facing partners who lack breast anatomy.
 */
...
describe('affection:rest_head_against_flat_chest action discovery', () => {
  let testFixture;
  ...
  beforeEach(async () => {
    ...
    configureActionDiscovery = () => {
      ...
      const originalResolve =
        scopeResolver.__restHeadAgainstFlatChestOriginalResolve ||
        scopeResolver.resolveSync.bind(scopeResolver);

      scopeResolver.__restHeadAgainstFlatChestOriginalResolve = originalResolve;
  ...
  describe('Action structure validation', () => {
    it('matches the expected affection action schema', () => {
      ...
      expect(restHeadAgainstFlatChestAction.template).toBe(
        "rest your head on {primary}'s chest"
      );
    });

    it('uses a flat-chested primary target definition', () => {
      expect(restHeadAgainstFlatChestAction.targets).toBeDefined();
      expect(restHeadAgainstFlatChestAction.targets.primary).toEqual(
