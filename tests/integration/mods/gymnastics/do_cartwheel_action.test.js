/**
 * @file Integration tests for the gymnastics:do_cartwheel chance-based action.
 * @description Tests the do_cartwheel action definition and handle_do_cartwheel rule
...
import actionDefinition from '../../../../data/mods/gymnastics/actions/do_cartwheel.action.json' assert { type: 'json' };
import ruleDefinition from '../../../../data/mods/gymnastics/rules/handle_do_cartwheel.rule.json' assert { type: 'json' };
import conditionDefinition from '../../../../data/mods/gymnastics/conditions/event-is-action-do-cartwheel.condition.json' assert { type: 'json' };

describe('gymnastics:do_cartwheel chance-based action', () => {
  describe('Action Definition Structure', () => {
    it('should have correct action ID and schema', () => {
      ...
      expect(actionDefinition.id).toBe('gymnastics:do_cartwheel');
      expect(actionDefinition.name).toBe('Do Cartwheel');
    });
    ...
    it('should have template showing chance percentage', () => {
      ...
      expect(actionDefinition.template).toContain('cartwheel');
    });
  ...
  describe('Condition Definition Structure', () => {
    it('should have correct schema and ID', () => {
      ...
      expect(conditionDefinition.id).toBe(
        'gymnastics:event-is-action-do-cartwheel'
      );
    });
  ...
  describe('Rule Structure Validation', () => {
    it('should have correct rule ID and schema', () => {
      ...
      expect(ruleDefinition.rule_id).toBe('handle_do_cartwheel');
    });
  ...
  describe('Outcome Branch Validation', () => {
    ...
    describe('SUCCESS branch', () => {
      it('should dispatch perceptible event with laterally message', () => {
        ...
        expect(dispatchOp).toBeDefined();
        expect(dispatchOp.parameters.description_text).toContain('laterally');
      });
    ...
    describe('FAILURE branch', () => {
      it('should dispatch perceptible event with wobbles message', () => {
        ...
        expect(dispatchOp).toBeDefined();
        expect(dispatchOp.parameters.description_text).toContain('wobbles');
      });
  ...
  describe('Narrative Messaging Validation', () => {
    ...
    it('should have SUCCESS message containing "laterally"', () => {
      const ruleString = JSON.stringify(ruleDefinition);
      expect(ruleString).toContain('laterally');
    });

    it('should have FAILURE message containing "wobbles"', () => {
      const ruleString = JSON.stringify(ruleDefinition);
      expect(ruleString).toContain('wobbles');
    });
