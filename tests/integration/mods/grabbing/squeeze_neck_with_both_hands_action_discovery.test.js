/**
 * @file Integration tests for grabbing:squeeze_neck_with_both_hands action discovery.
...
import squeezeNeckAction from '../../../../data/mods/grabbing/actions/squeeze_neck_with_both_hands.action.json';

const ACTION_ID = 'grabbing:squeeze_neck_with_both_hands';

describe('grabbing:squeeze_neck_with_both_hands action discovery', () => {
  let testFixture;
