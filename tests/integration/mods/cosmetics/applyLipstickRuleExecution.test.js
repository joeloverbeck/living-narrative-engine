/**
 * @file Integration tests for the cosmetics:apply_lipstick rule.
...
import applyLipstickRule from '../../../../data/mods/cosmetics/rules/handle_apply_lipstick.rule.json' assert { type: 'json' };
import eventIsActionApplyLipstick from '../../../../data/mods/cosmetics/conditions/event-is-action-apply-lipstick.condition.json' assert { type: 'json' };

const ACTION_ID = 'cosmetics:apply_lipstick';

describe('cosmetics:apply_lipstick rule execution', () => {
  let testFixture;
