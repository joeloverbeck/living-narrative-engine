/**
 * @file Integration tests for affection-gentle-touch:tickle_target_playfully action discovery.
...
import tickleTargetPlayfullyAction from '../../../../data/mods/affection-gentle-touch/actions/tickle_target_playfully.action.json';

const ACTION_ID = 'affection-gentle-touch:tickle_target_playfully';

describe('affection-gentle-touch:tickle_target_playfully action discovery', () => {
  let testFixture;
  let configureActionDiscovery;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction('affection-gentle-touch', ACTION_ID);
  ...
  describe('Action structure validation', () => {
    ...
    it('requires actor closeness and uses the Petal Pink Tenderness color palette', () => {
