/**
 * @file Integration tests for affection-gentle-touch:push_target_playfully action discovery.
...
import pushTargetPlayfullyAction from '../../../../data/mods/affection-gentle-touch/actions/push_target_playfully.action.json';

const ACTION_ID = 'affection-gentle-touch:push_target_playfully';

describe('affection-gentle-touch:push_target_playfully action discovery', () => {
  let testFixture;
