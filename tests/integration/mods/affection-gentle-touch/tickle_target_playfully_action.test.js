/**
 * @file Integration tests for the affection-gentle-touch:tickle_target_playfully action and rule.
...
import handleTickleTargetPlayfullyRule from '../../../../data/mods/affection-gentle-touch/rules/handle_tickle_target_playfully.rule.json';
import eventIsActionTickleTargetPlayfully from '../../../../data/mods/affection-gentle-touch/conditions/event-is-action-tickle-target-playfully.condition.json';
...
describe('affection-gentle-touch:tickle_target_playfully action integration', () => {
  let testFixture;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction(
      'affection-gentle-touch',
      ACTION_ID,
