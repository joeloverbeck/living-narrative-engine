/**
 * @file Integration tests for the affection-gentle-touch:touch_nose_tenderly action and rule.
...
describe('affection-gentle-touch:touch_nose_tenderly action integration', () => {
  let testFixture;
  let addNoseAnatomy;
