/**
 * @file Integration tests for the affection-gentle-touch:brush_hand action and rule.
...
describe('affection-gentle-touch:brush_hand action integration', () => {
  let testFixture;

  beforeEach(async () => {
    testFixture = await ModTestFixture.forAction(
      'affection-gentle-touch',
      'affection-gentle-touch:brush_hand',
      brushHandRule,
  ...
  it('is not discoverable when the target has no hand anatomy', () => {
    ...
    expect(ids).not.toContain('affection-gentle-touch:brush_hand');
  });
