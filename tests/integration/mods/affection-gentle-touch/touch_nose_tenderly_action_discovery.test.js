/**
 * @file Integration tests for affection-gentle-touch:touch_nose_tenderly action discovery.
...
import touchNoseTenderlyAction from '../../../../data/mods/affection-gentle-touch/actions/touch_nose_tenderly.action.json';
import { ActionResult } from '../../../../src/actions/core/actionResult.js';
import { ActionTargetContext } from '../../../../src/models/actionTargetContext.js';
import SimpleEntityManager from '../../../common/entities/simpleEntityManager.js';

const ACTION_ID = 'affection-gentle-touch:touch_nose_tenderly';

describe('affection-gentle-touch:touch_nose_tenderly action discovery', () => {
  let testBed;
  let addNoseAnatomy;
  ...
  describe('Action structure validation', () => {
    it('matches the expected affection-gentle-touch action schema', () => {
      ...
      expect(touchNoseTenderlyAction.targets).toBe(
        'affection-gentle-touch:close_actors_with_nose_or_entity_kneeling_before_actor'
      );
      expect(touchNoseTenderlyAction.required_components.actor).toContain(
        'personal-space-states:closeness'
      );
      expect(touchNoseTenderlyAction.visual.backgroundColor).toBe('#d4a5a5');
      expect(touchNoseTenderlyAction.visual.textColor).toBe('#1a0a0a');
      expect(touchNoseTenderlyAction.visual.hoverBackgroundColor).toBe(
        '#e0b8b8'
      );
      expect(touchNoseTenderlyAction.visual.hoverTextColor).toBe('#1a0a0a');
    });
  });
