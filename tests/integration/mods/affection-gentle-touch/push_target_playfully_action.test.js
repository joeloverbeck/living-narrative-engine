/**
 * @file Integration tests for the affection-gentle-touch:push_target_playfully action and rule.
...
import handlePushTargetPlayfullyRule from '../../../../data/mods/affection-gentle-touch/rules/handle_push_target_playfully.rule.json';
import eventIsActionPushTargetPlayfully from '../../../../data/mods/affection-gentle-touch/conditions/event-is-action-push-target-playfully.condition.json';

const ACTION_ID = 'affection-gentle-touch:push_target_playfully';

describe('affection-gentle-touch:push_target_playfully action integration', () => {
  let testFixture;
