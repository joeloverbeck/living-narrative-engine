/**
 * @file Integration tests for the affection-gentle-touch:pat_head_affectionately action and rule.
...
describe('affection-gentle-touch:pat_head_affectionately action integration', () => {
  let testFixture;
