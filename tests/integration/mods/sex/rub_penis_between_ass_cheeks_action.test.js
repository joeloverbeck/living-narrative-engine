/**
 * @file Integration tests for the sex:rub_penis_between_ass_cheeks action and rule.
...
describe('sex:rub_penis_between_ass_cheeks action integration', () => {
  let testFixture;

  beforeEach(async () => {
    // Create test fixture with auto-loaded files
    testFixture = await ModTestFixture.forAction('sex', 'sex:rub_penis_between_ass_cheeks');
