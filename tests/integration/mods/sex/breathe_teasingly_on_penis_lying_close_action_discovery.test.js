/**
 * @file Integration tests for sex-penile-oral-teasing:breathe_teasingly_on_penis_lying_close action discovery.
...
describe('sex-penile-oral-teasing:breathe_teasingly_on_penis_lying_close action discovery', () => {
  let testFixture;
