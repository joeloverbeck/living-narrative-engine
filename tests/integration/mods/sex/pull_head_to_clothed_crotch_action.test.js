/**
 * @file Integration tests for sex-penile-oral:pull_head_to_clothed_crotch action and rule.
...
} from '../../../common/mods/sex/pullHeadToClothedCrotchFixtures.js';
import pullHeadToClothedCrotchAction from '../../../../data/mods/sex-penile-oral/actions/pull_head_to_clothed_crotch.action.json';
...
describe('sex-penile-oral:pull_head_to_clothed_crotch action integration', () => {
  let testFixture;
