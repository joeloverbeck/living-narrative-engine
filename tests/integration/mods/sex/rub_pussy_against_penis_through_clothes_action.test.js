/**
 * @file Integration tests for sex:rub_pussy_against_penis_through_clothes action execution.
...
describe('sex:rub_pussy_against_penis_through_clothes action execution', () => {
  let testFixture;
