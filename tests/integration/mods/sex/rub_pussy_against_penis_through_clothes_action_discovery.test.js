/**
 * @file Integration tests for sex:rub_pussy_against_penis_through_clothes action discovery.
...
import rubPussyAgainstPenisRule from '../../../../data/mods/sex/rules/handle_rub_pussy_against_penis_through_clothes.rule.json';
...
describe('sex:rub_pussy_against_penis_through_clothes action discovery', () => {
  ...
  beforeEach(async () => {
    ...
    testEnv.unifiedScopeResolver.resolveSync = (scopeName, context) => {
      if (scopeName === 'sex:actors_with_penis_facing_straddler_covered') {
  ...
  describe('Action structure validation', () => {
    ...
    it('should have correct primary scope', () => {
      expect(rubPussyAgainstPenisAction.targets.primary.scope).toBe(
        'sex:actors_with_penis_facing_straddler_covered'
      );
    });
  ...
  describe('Action discovery scenarios', () => {
    it('should appear when actor is straddling sitting target with covered penis', async () => {
      ...
      const foundAction = actions.find(
        (a) => a.id === 'sex:rub_pussy_against_penis_through_clothes'
      );
