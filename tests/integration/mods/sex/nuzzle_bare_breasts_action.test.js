/**
 * @file Integration tests for the sex-breastplay:nuzzle_bare_breasts action and rule.
 * @description Verifies narration, perceptible event payload, and turn resolution for bare breast nuzzling.
 */
...
const EXPECTED_MESSAGE =
  "Selene nuzzles their face against Mira's bare breasts.";

/**
 * @description Registers the nuzzle bare breasts action with the action index.
...
describe('sex-breastplay:nuzzle_bare_breasts action integration', () => {
  let testFixture;
  ...
  it('dispatches the bare breast nuzzling narration and perceptible event', async () => {
