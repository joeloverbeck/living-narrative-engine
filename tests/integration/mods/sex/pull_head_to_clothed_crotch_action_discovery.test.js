/**
 * @file Integration tests for sex-penile-oral:pull_head_to_clothed_crotch action discovery.
...
describe('sex-penile-oral:pull_head_to_clothed_crotch action discovery', () => {
  let testFixture;
