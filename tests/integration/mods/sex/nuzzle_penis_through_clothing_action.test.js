/**
 * @file Integration tests for the sex-penile-oral-teasing:nuzzle_penis_through_clothing action and rule.
...
describe('sex-penile-oral-teasing:nuzzle_penis_through_clothing action integration', () => {
  let testFixture;
  ...
  beforeEach(async () => {
    ...
    testFixture = await ModTestFixture.forAction(
      ...
      'sex-penile-oral-teasing:nuzzle_penis_through_clothing'
    );
  ...
  it('handles missing target gracefully', async () => {
    ...
    await expect(async () => {
      await testFixture.eventBus.dispatch('core:attempt_action', {
        actionId: 'sex-penile-oral-teasing:nuzzle_penis_through_clothing',
        actorId: 'alice',
