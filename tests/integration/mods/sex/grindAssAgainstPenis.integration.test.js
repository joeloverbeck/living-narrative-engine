/**
 * @file Integration tests for the sex:grind_ass_against_penis action and rule.
...
describe('sex:grind_ass_against_penis action integration', () => {
  let testFixture;
  ...
  it('should execute successfully with correct perceptible event', async () => {
    ...
    await testFixture.eventBus.dispatch('core:attempt_action', {
      actionId: 'sex:grind_ass_against_penis',
      actorId: 'alice',
      primaryId: 'bob',
      secondaryId: 'pants1',
    });
