/**
 * @file Integration tests for sex:rub_penis_against_penis action discovery.
...
} from '../../../common/mods/sex/rubPenisAgainstPenisFixtures.js';
import rubPenisAgainstPenisAction from '../../../../data/mods/sex/actions/rub_penis_against_penis.action.json';
...
describe('sex:rub_penis_against_penis action discovery', () => {
  let testFixture;
