/**
 * @file Integration tests for creature-attacks:peck_target action discovery
 ...
 *                 (via creature-attacks:actor-has-beak condition using hasPartSubTypeContaining operator)
 *              2. Primary target: Beak body part with damage-types:damage_capabilities
 *                 (via creature-attacks:actor_beak_body_parts scope)
 ...
 * @see data/mods/creature-attacks/actions/peck_target.action.json
 * @see data/mods/creature-attacks/conditions/actor-has-beak.condition.json
 * @see data/mods/creature-attacks/scopes/actor_beak_body_parts.scope
 */

import { describe, it, beforeEach, afterEach, expect } from '@jest/globals';
import { createActionDiscoveryBed } from '../../../common/actions/actionDiscoveryServiceTestBed.js';
import '../../../common/actionMatchers.js';
import peckTargetAction from '../../../../data/mods/creature-attacks/actions/peck_target.action.json';
import { ActionResult } from '../../../../src/actions/core/actionResult.js';
import { ActionTargetContext } from '../../../../src/models/actionTargetContext.js';
import SimpleEntityManager from '../../../common/entities/simpleEntityManager.js';

const ACTION_ID = 'creature-attacks:peck_target';

describe('creature-attacks:peck_target action discovery', () => {
  let testBed;
  ...
  describe('Action structure validation', () => {
    it('matches the expected creature-attacks action schema', () => {
    ...
    it('has prerequisite referencing actor-has-beak condition', () => {
      ...
      expect(prerequisite.logic.condition_ref).toBe('creature-attacks:actor-has-beak');
    ...
    it('uses the Feral Amber visual styling', () => {
      expect(peckTargetAction.visual).toBeDefined();
      expect(peckTargetAction.visual.backgroundColor).toBe('#8b5a00');
      expect(peckTargetAction.visual.textColor).toBe('#fff8e1');
    });
  ...
  describe('Positive discovery scenarios', () => {
    ...
    it('should be available when actor has chicken_beak with damage capabilities', () => {
      ...
      // 4. Prerequisite: creature-attacks:actor-has-beak passes (hasPartSubTypeContaining)
      // 5. Primary scope: creature-attacks:actor_beak_body_parts returns beak entity
      ...
      expect(peckTargetAction.prerequisites[0].logic.condition_ref).toBe(
        'creature-attacks:actor-has-beak'
      );
    });
  ...
  describe('Negative discovery scenarios', () => {
    it('is not available when actor has no beak body part', async () => {
      ...
      testBed.mocks.targetResolutionService.resolveTargets.mockImplementation(
        (scopeName) => {
          if (scopeName === 'creature-attacks:actor_beak_body_parts') {
