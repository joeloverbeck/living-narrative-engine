 ...
 * @file Integration tests for creature-attacks:peck_target action prerequisites
 * @description Tests that the action correctly requires actor to have a beak
 *
 * Tests the prerequisite `creature-attacks:actor-has-beak` which uses
...
import actorHasBeakCondition from '../../../../data/mods/creature-attacks/conditions/actor-has-beak.condition.json';

describe('creature-attacks:peck_target prerequisites', () => {
  ...
  beforeEach(() => {
    ...
    mockGameDataRepository.getConditionDefinition.mockImplementation(
      (conditionId) => {
        if (conditionId === 'creature-attacks:actor-has-beak') {
  ...
  describe('action definition structure', () => {
    ...
    test('should reference creature-attacks:actor-has-beak condition', () => {
    ...
    test('should preserve action metadata', () => {
      expect(peckTargetAction.id).toBe('creature-attacks:peck_target');
    ...
    test('should use Feral Amber visual styling', () => {
  ...
  describe('condition definition validation', () => {
    ...
    test('condition ID should match what the action references', () => {
      expect(actorHasBeakCondition.id).toBe('creature-attacks:actor-has-beak');
    });
