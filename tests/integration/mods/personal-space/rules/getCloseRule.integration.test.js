...
import getCloseRule from '../../../../../data/mods/personal-space/rules/get_close.rule.json';
import eventIsActionGetClose from '../../../../../data/mods/personal-space/conditions/event-is-action-get-close.condition.json';
    ...
    testEnv.reset([
      ...
      },
      {
        ...
        components: {
          ...
          [POSITION_COMPONENT_ID]: { locationId: 'room1' },
          'personal-space-states:closeness': { partners: ['d1'] },
        },
      },
      {
        id: 'd1',
        components: {
          ...
          [POSITION_COMPONENT_ID]: { locationId: 'room1' },
          'personal-space-states:closeness': { partners: ['c1'] },
        },
      },
    ]);
