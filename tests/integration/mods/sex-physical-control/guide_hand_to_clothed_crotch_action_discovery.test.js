...
/**
 * Installs a scope override for personal-space-states:close_actors_facing_each_other_or_behind_target_with_hands.
...
function installCloseActorsFacingOrBehindOverride(fixture) {
  ...
  resolver.resolveSync = (scopeName, context) => {
    if (
      scopeName ===
      'personal-space-states:close_actors_facing_each_other_or_behind_target_with_hands'
    ) {
