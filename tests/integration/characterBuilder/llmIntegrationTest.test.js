...
describe('Character Builder LLM Integration', () => {
  ...
  describe('LLM Configuration Integration', () => {
    test('should use base openrouter-claude-sonnet-4 configuration with dynamic schema injection', async () => {
        ...
        thematicDirections: [
          {
            ...
            description: 'A character who must overcome their deep-seated reluctance to embrace their destiny as a hero',
            coreTension: 'Desire for normalcy versus the overwhelming call to adventure',
            uniqueTwist: 'Their reluctance is actually a hidden strength that protects them',
            narrativePotential: 'Stories of personal growth through facing adversity and accepting responsibility',
          },
          {
            title: 'The Skilled Archer',
            description: 'A character defined by their exceptional marksmanship and uncanny ability to hit impossible targets',
            coreTension: 'Perfect precision in archery contrasted with complete chaos in personal life',
            uniqueTwist: 'Their arrows always find their mark, but somehow never hit the intended target',
            narrativePotential: 'Tales of finding true purpose while dealing with constant misdirection and unintended consequences',
          },
          {
            title: 'The Ditzy Genius',
            description: 'A character whose apparent clumsiness and social awkwardness cleverly conceals their remarkable intellectual insights',
            coreTension: 'Extreme social awkwardness contrasted with unparalleled intellectual brilliance',
            uniqueTwist: 'Their embarrassing mistakes consistently lead to groundbreaking discoveries',
            narrativePotential: 'Comedic adventures with surprising depth, featuring accidental heroism and serendipitous breakthroughs',
          },
        ],
      });
      ...
      expect(mockLlmStrategyFactory.getStrategy).toHaveBeenCalledWith(expect.objectContaining({
        configId: 'openrouter-claude-sonnet-4',
        modelIdentifier: 'anthropic/claude-sonnet-4',
        apiType: 'openrouter',
        jsonOutputStrategy: {
        ...
        thematicDirections: [
          {
            ...
            description: 'The first custom thematic direction explores unique character development paths and narrative possibilities',
            coreTension: 'The fundamental conflict between personal desires and societal expectations',
            uniqueTwist: 'An unexpected revelation that completely reframes the character journey',
            narrativePotential: 'Rich storytelling opportunities exploring themes of identity and transformation',
          },
          {
            title: 'Custom Direction 2',
            description: 'The second custom thematic direction delves into complex relationships and moral ambiguity',
            coreTension: 'The struggle between maintaining integrity and achieving ambitious goals',
            uniqueTwist: 'Their greatest strength becomes their most significant weakness',
            narrativePotential: 'Opportunities for exploring moral complexity and character growth through difficult choices',
          },
          {
            title: 'Custom Direction 3',
            description: 'The third custom thematic direction examines legacy, heritage, and the weight of expectations',
            coreTension: 'Balancing respect for tradition with the need for revolutionary change',
            uniqueTwist: 'The solution to their problems lies in embracing what they rejected',
            narrativePotential: 'Stories exploring generational conflict, cultural evolution, and personal reinvention',
          },
        ],
      });
        ...
        thematicDirections: [
          {
            ...
            description: 'The first test direction explores foundational character archetypes and narrative structures',
            coreTension: 'The eternal struggle between order and chaos in character development',
            uniqueTwist: 'What seems like weakness becomes the source of greatest strength',
            narrativePotential: 'Stories exploring personal transformation through unexpected challenges and revelations',
          },
          {
            title: 'Test Direction 2',
            description: 'The second test direction delves into complex interpersonal dynamics and moral choices',
            coreTension: 'Navigating the conflict between personal ambition and collective responsibility',
            uniqueTwist: 'The path to victory requires embracing apparent defeat and vulnerability',
            narrativePotential: 'Narratives examining sacrifice, redemption, and the true meaning of heroism',
          },
          {
            title: 'Test Direction 3',
            description: 'The third test direction examines themes of legacy, destiny, and self-determination',
            coreTension: 'Breaking free from predetermined fate while honoring ancestral wisdom',
            uniqueTwist: 'The prophecy was never about them, but about who they would inspire',
            narrativePotential: 'Epic tales of forging new paths while respecting traditional values and heritage',
          },
        ],
      });
  ...
  describe('LLM Response Processing Integration', () => {
    test('should properly clean and parse LLM response', async () => {
      ...
      const cleanedResponse = JSON.stringify({
        thematicDirections: [
          ...
          {
            title: 'The Apprentice of Time',
            description: 'A young wizard who manipulates temporal forces with growing but unpredictable powers',
            coreTension: 'The desire to change the past versus accepting the present',
            uniqueTwist: 'Can see all possible futures but cannot change their own',
            narrativePotential: 'Stories of fate, free will, and temporal paradoxes',
          },
          {
            title: 'The Scholar of Forbidden Arts',
            description: 'A knowledge seeker who delves into dangerous and forbidden magical practices despite warnings',
            coreTension: 'Academic curiosity versus ethical boundaries',
            uniqueTwist: 'Their research accidentally benefits their enemies',
            narrativePotential: 'Stories of unintended consequences and moral dilemmas',
          },
    ...
    test('should handle multiple thematic directions in response', async () => {
      ...
      const mockLlmResponse = JSON.stringify({
        thematicDirections: [
          {
            title: 'Direction One',
            description: 'First thematic direction exploring the complex relationship between personal identity and societal expectations',
            coreTension: 'The eternal struggle between individual authenticity and social conformity',
            uniqueTwist: 'Their greatest strength emerges from embracing their perceived weaknesses',
            narrativePotential: 'Rich narrative opportunities for self-discovery and breaking social boundaries',
          },
          {
            title: 'Direction Two',
            description: 'Second thematic direction delving into the paradox of power and the responsibility it brings to those who wield it',
            coreTension: 'The conflict between using power for personal gain versus serving the greater good',
            uniqueTwist: 'True power comes from knowing when not to use it rather than from its exercise',
            narrativePotential: 'Stories exploring moral complexity, difficult choices, and the burden of leadership',
          },
          {
            title: 'Direction Three',
            description: 'Third thematic direction examining the nature of legacy and how our actions echo through generations',
            coreTension: 'Building for the future while being bound by the past and its expectations',
            uniqueTwist: 'The legacy they leave is completely different from what they intended to create',
            narrativePotential: 'Generational sagas exploring unintended consequences and the ripple effects of choices',
          },
        ],
      });
    ...
    test('should include LLM metadata in generated directions', async () => {
      ...
      mockStrategy.execute.mockImplementation(() => 
        new Promise(resolve => setTimeout(() => resolve(mockLlmResponse), 10))
      );
      mockLlmJsonService.clean.mockReturnValue(mockLlmResponse);
      mockLlmJsonService.parseAndRepair.mockResolvedValue(JSON.parse(mockLlmResponse));
        ...
        thematicDirections: [
          {
            ...
            description: 'The first direction for testing performance measurement explores temporal themes and efficiency paradoxes',
            coreTension: 'The fundamental conflict between achieving speed and maintaining accuracy',
            uniqueTwist: 'Time becomes relative when pursuing perfection at any cost',
            narrativePotential: 'Adventures exploring temporal mechanics, causality loops, and the nature of progress',
          },
          {
            title: 'Performance Test Direction 2',
            description: 'The second direction for testing performance measurement analyzes efficiency versus completeness dilemmas',
            coreTension: 'Balancing operational efficiency against the need for comprehensive thoroughness',
            uniqueTwist: 'Shortcuts paradoxically lead to longer, more complex paths',
            narrativePotential: 'Stories exploring optimization strategies, unintended consequences, and meaningful trade-offs',
          },
          {
            title: 'Performance Test Direction 3',
            description: 'The third direction for testing performance measurement examines observation effects and measurement paradoxes',
            coreTension: 'The conflict between objective measurement and subjective experience',
            uniqueTwist: 'The very act of measuring fundamentally changes the outcome being measured',
            narrativePotential: 'Narratives exploring quantum mechanics principles applied to software development and life',
          },
        ],
      });
