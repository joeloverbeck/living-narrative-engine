...
describe('Bending over scopes integration', () => {
  ...
  beforeEach(() => {
    ...
    const mockScopes = {
      ...
      'bending:surface_im_bending_over': {
        definition:
          'bending:surface_im_bending_over := entities(bending:allows_bending_over)[][{"==": [{"var": "entity.id"}, {"var": "actor.components.bending-states:bending_over.surface_id"}]}]',
        modId: 'positioning',
      },
    };
  ...
  describe('available_surfaces scope', () => {
    it('should return surfaces in actor location', () => {
      ...
      const scopeDef = scopeRegistry.getScope('bending:available_surfaces');
      ...
      entityManager = new SimpleEntityManager([
        {
          id: 'test:actor',
          components: {
            'bending-states:bending_over': { surface_id: 'kitchen:counter' },
          },
        },
        {
          id: 'kitchen:counter',
