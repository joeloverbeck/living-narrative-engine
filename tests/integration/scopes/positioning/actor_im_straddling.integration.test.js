/**
 * @file Integration tests for positioning:actor_im_straddling scope
...
describe('positioning:actor_im_straddling scope integration', () => {
  let entityManager;
  let scopeEngine;
  let scopeRegistry;
  let logger;
  ...
  beforeEach(() => {
    ...
    const mockScopes = {
      'positioning:actor_im_straddling': {
        ...
        definition:
          'positioning:actor_im_straddling := entities(core:actor)[][{"==": [{"var": "entity.id"}, {"var": "actor.components.positioning:straddling_waist.target_id"}]}]',
        modId: 'positioning',
      },
    };
  ...
  it('should return straddled actor from straddling_waist.target_id', () => {
    ...
    const scopeDef = scopeRegistry.getScope('positioning:actor_im_straddling');
