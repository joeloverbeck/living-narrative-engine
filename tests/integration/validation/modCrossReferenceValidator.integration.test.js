  ...
  describe('Integration with File System', () => {
    it('should handle different file types in mod directory', async () => {
      ...
      await fs.writeFile(
        ...
        JSON.stringify({
          id: 'test',
          condition: { condition_ref: 'personal-space:actor-is-in-closeness' },
        })
      );
