...
describe('Enhanced Cross-Reference Validation Integration', () => {
  ...
  it('should perform end-to-end enhanced validation with detailed reporting', async () => {
    ...
    extractor.extractReferencesWithFileContext.mockResolvedValue(mockContextualReferences);
    ...
    // Test JSON reporting
    const jsonReport = reporter.generateReport(validationResult, 'json', { pretty: true });
  ...
  it('should handle ecosystem validation with mixed results', async () => {
    ...
    extractor.extractReferencesWithFileContext
      .mockResolvedValueOnce(violatingContextualReferences); // For violating_mod call
    ...
    const ecosystemReport = reporter.generateReport(ecosystemResults, 'console');

    expect(ecosystemReport).toContain('Living Narrative Engine - Cross-Reference Validation Report');
    ...
    const ecosystemJsonReport = reporter.generateReport(ecosystemResults, 'json');
