    ...
    class TestController {
      ...
      async initialize() {
        ...
        try {
          ...
          console.warn(
            'LlmSelectionModal not registered, continuing without it'
          );
    ...
    class TestController {
      ...
      async initialize() {
        ...
        if (!this.#container.isRegistered(tokens.LlmSelectionModal)) {
          ...
          const { LlmSelectionModal } = await import(
            '../../src/domUI/llmSelectionModal.js'
          );
          const DocumentContext = (
            await import('../../src/domUI/documentContext.js')
          ).default;
          ...
          this.#container.register(
            ...
            () =>
              new LlmSelectionModal({
                ...
                documentContext: this.#container.resolve(
                  tokens.DocumentContext
                ),
