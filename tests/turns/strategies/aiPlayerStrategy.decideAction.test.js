    ...
    describe('decideAction', () => {
        ...
        beforeEach(() => {
            ...
            mockGameStateDto_da = {
                ...
                perceptionLog: [{description: "Something happened in DTO", type: "generic", timestamp: Date.now()}],
                availableActions: [{
                    id: 'act1',
                    command: 'do act1',
            ...
            mockPromptDataObject_da = {
                ...
                perceptionLogArray: [{description: "Mock event in PromptData", type: "generic", timestamp: Date.now()}],
