// src/tests/turns/order/turnOrderService.startNewRound.initiative.test.js
  ...
  describe("startNewRound ('initiative')", () => {
    ...
    it('Test Case 11.3.2: should handle missing or invalid initiative scores, defaulting to 0 and logging warnings', () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith(
        'TurnOrderService.startNewRound (initiative): Entity "b" missing valid initiative score. Defaulting to 0.'
      );
      expect(mockLogger.warn).toHaveBeenCalledWith(
