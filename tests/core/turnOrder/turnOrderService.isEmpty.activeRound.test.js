...
describe('TurnOrderService', () => {
    ...
    beforeEach(() => {
        ...
        SimpleRoundRobinQueue.mockImplementation(() => {
            ...
            return /** @type {import('../../../src/turns/order/queues/simpleRoundRobinQueue.js').SimpleRoundRobinQueue} */ (mockSimpleQueueInstance);
        });
        ...
        InitiativePriorityQueue.mockImplementation(() => {
            ...
            // Ensure the mock function returns the created mock instance
            // Type assertion needed as mockImplementation signature is broad
            return /** @type {import('../../../src/turns/order/queues/initiativePriorityQueue.js').InitiativePriorityQueue} */ (mockInitiativeQueueInstance);
        });
    });
