...
describe('BaseManifestItemLoader Constructor', () => {
    ...
    it('should instantiate successfully with valid contentType and dependencies', () => {
        ...
        const testLoaderInstance = new BaseManifestItemLoader(
            mockContentType, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, mockLogger
        );
        ...
        expect(mockConfig.getContentTypeSchemaId).toHaveBeenCalledWith(mockContentType);
    ...
    describe('ContentType Validation', () => {
        it('should throw TypeError if contentType is null', () => {
            expect(() => new BaseManifestItemLoader(null, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, mockLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a non-empty string for 'contentType'. Received: null"));
        });

        it('should throw TypeError if contentType is undefined', () => {
            expect(() => new BaseManifestItemLoader(undefined, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, mockLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a non-empty string for 'contentType'. Received: undefined"));
        });

        it('should throw TypeError if contentType is an empty string', () => {
            expect(() => new BaseManifestItemLoader('', mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, mockLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a non-empty string for 'contentType'. Received: "));
        });
        ...
        it('should throw TypeError if contentType is not a string', () => {
            expect(() => new BaseManifestItemLoader(123, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, mockLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a non-empty string for 'contentType'. Received: 123"));
        });
    });
    ...
    describe('IConfiguration Validation', () => {
        it('should throw TypeError and log error if config is null', () => {
            ...
            expect(() => new BaseManifestItemLoader(mockContentType, null, mockResolver, mockFetcher, mockValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid IConfiguration instance."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: Invalid IConfiguration dependency provided.");
        });

        it('should throw TypeError and log error if config is not an object', () => {
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, "not-an-object", mockResolver, mockFetcher, mockValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid IConfiguration instance."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: Invalid IConfiguration dependency provided.");
        });
        ...
        it('should throw TypeError and log error if config is missing getModsBasePath', () => {
            ...
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, incompleteConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader: IConfiguration instance must have a 'getModsBasePath' method."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: IConfiguration missing 'getModsBasePath' method.");
        });
        ...
        it('should throw TypeError and log error if config is missing getContentTypeSchemaId', () => {
            ...
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: IConfiguration missing 'getContentTypeSchemaId' method.");
        });
    });
    ...
    describe('IPathResolver Validation', () => {
        it('should throw TypeError and log error if pathResolver is null', () => {
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, null, mockFetcher, mockValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid IPathResolver instance."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: Invalid IPathResolver dependency provided.");
        });
        ...
        it('should throw TypeError and log error if pathResolver is missing resolveModContentPath', () => {
            ...
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, incompleteResolver, mockFetcher, mockValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader: IPathResolver instance must have a 'resolveModContentPath' method."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: IPathResolver missing 'resolveModContentPath' method.");
        });
    });
    ...
    describe('IDataFetcher Validation', () => {
        it('should throw TypeError and log error if dataFetcher is null', () => {
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, null, mockValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid IDataFetcher instance."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: Invalid IDataFetcher dependency provided.");
        });
        ...
        it('should throw TypeError and log error if dataFetcher is missing fetch', () => {
            ...
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, incompleteFetcher, mockValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader: IDataFetcher instance must have a 'fetch' method."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: IDataFetcher missing 'fetch' method.");
        });
    });
    ...
    describe('ISchemaValidator Validation', () => {
        it('should throw TypeError and log error if schemaValidator is null', () => {
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, null, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid ISchemaValidator instance."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: Invalid ISchemaValidator dependency provided.");
        });
        ...
        it('should throw TypeError and log error if schemaValidator is missing validate', () => {
            ...
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, incompleteValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader: ISchemaValidator instance must have a 'validate' method."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: ISchemaValidator missing 'validate' method.");
        });
        ...
        it('should throw TypeError and log error if schemaValidator is missing getValidator', () => {
            ...
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: ISchemaValidator missing 'getValidator' method.");
        });

        it('should throw TypeError and log error if schemaValidator is missing isSchemaLoaded', () => { // <<< ADDED: Test for isSchemaLoaded check
            const incompleteValidator = {...createMockSchemaValidator(), isSchemaLoaded: undefined};
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, incompleteValidator, mockRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader: ISchemaValidator instance must have a 'isSchemaLoaded' method."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: ISchemaValidator missing 'isSchemaLoaded' method.");
        });
    });
    ...
    describe('IDataRegistry Validation', () => {
        it('should throw TypeError and log error if dataRegistry is null', () => {
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, mockValidator, null, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid IDataRegistry instance."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: Invalid IDataRegistry dependency provided.");
        });
        ...
        it('should throw TypeError and log error if dataRegistry is missing store', () => {
            ...
            const validLogger = createMockLogger();
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, mockValidator, incompleteRegistry, validLogger))
                .toThrow(new TypeError("BaseManifestItemLoader: IDataRegistry instance must have a 'store' method."));
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: IDataRegistry missing 'store' method.");
        });
        ...
        it('should throw TypeError and log error if dataRegistry is missing get', () => {
            ...
            expect(validLogger.error).toHaveBeenCalledWith("BaseManifestItemLoader: IDataRegistry missing 'get' method.");
        });
    });
    ...
    describe('ILogger Validation', () => {
        ...
        it('should throw TypeError if logger is null', () => {
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, null))
        ...
        it('should throw TypeError if logger is undefined', () => {
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, undefined))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid ILogger instance."));
        });

        it('should throw TypeError if logger is not an object', () => {
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, 'not-an-object'))
                .toThrow(new TypeError("BaseManifestItemLoader requires a valid ILogger instance."));
        });

        it('should throw TypeError if logger is missing info', () => {
            const incompleteLogger = {...createMockLogger(), info: undefined};
            expect(() => new BaseManifestItemLoader(mockContentType, mockConfig, mockResolver, mockFetcher, mockValidator, mockRegistry, incompleteLogger))
    ...
    describe('Abstract Method Stub', () => {
        it('_processFetchedItem should reject with the specific abstract error message', async () => {
            ...
            await expect(freshLoader._processFetchedItem('modId', 'filename', 'path', {}, 'someTypeName'))
                .rejects.toThrow('Abstract method _processFetchedItem must be implemented by subclass.');
        });
    });
});