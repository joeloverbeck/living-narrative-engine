...
const createMockSchemaValidator = () => {
    ...
    return {
        ...
        getValidator: jest.fn().mockImplementation((schemaId) => {
            ...
            console.warn("WARNING: mockValidator.getValidator was called unexpectedly in test!");
...
describe('RuleLoader (Manifest Input Handling via loadItemsForMod)', () => {
    ...
    describe('Valid Input', () => {
        it('should resolve valid rule filenames and process them successfully', async () => {
            ...
            expect(mockValidator.isSchemaLoaded).toHaveBeenCalledWith(defaultRuleSchemaId); // Called by _validatePrimarySchema
            expect(mockValidator.validate).toHaveBeenCalledTimes(2);
            expect(mockValidator.validate).toHaveBeenCalledWith(defaultRuleSchemaId, dataForRule1);
            expect(mockValidator.validate).toHaveBeenCalledWith(defaultRuleSchemaId, dataForRule2);
    ...
    describe('Empty/Invalid Entries in rules Array', () => {
        ...
        it('should filter out invalid entries, log warnings, and process only valid ones', async () => {
            ...
            expect(mockLogger.warn).toHaveBeenCalledWith(`Mod '${modId}': Invalid non-string entry found in '${RULE_CONTENT_KEY}' list:`, null);
            ...
            expect(mockValidator.validate).toHaveBeenCalledWith(defaultRuleSchemaId, dataForValidFile);
            ...
            expect(mockRegistry.store).toHaveBeenCalledWith(
                ...
                expect.objectContaining({ // Check final stored object structure
                    ...dataForValidFile,
