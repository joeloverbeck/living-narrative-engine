// src/tests/core/worldContext.edgeCases.test.js
// --- FILE START ---
...
describe('WorldContext Edge Cases', () => {
    ...
    beforeEach(() => {
        ...
        const entityManagerForTest = new EntityManager();
    ...
    test('getCurrentLocation() returns null and warns when location entity referenced by position does not exist', () => {
        ...
        expect(loggerWarnSpy).toHaveBeenCalledWith(expect.stringContaining(`Could not find location entity with ID 'nonexistent_loc' referenced by actor 'player1'`));
    });
});
// --- FILE END ---