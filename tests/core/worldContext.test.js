...
import WorldContext from '../../src/context/worldContext.js'; // Adjust path if needed
import Entity from '../../src/entities/entity.js'; // Adjust path if needed
import {POSITION_COMPONENT_ID, CURRENT_ACTOR_COMPONENT_ID} from '../../src/constants/componentIds.js'; // Adjust path
