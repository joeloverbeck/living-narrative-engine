...
describe('RuleLoader (Rule Processing Logic via loadItemsForMod)', () => {
    ...
    describe('Ticket 4.5.1: Happy Path Rule Processing', () => {
        ...
        it('should successfully process multiple valid rules from manifest', async () => {
            ...
            expect(mockValidator.validate).toHaveBeenCalledWith(ruleSchemaId, expect.objectContaining(ruleDataA));
            expect(mockValidator.validate).toHaveBeenCalledWith(ruleSchemaId, expect.objectContaining(ruleDataB));
