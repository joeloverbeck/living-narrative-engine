...
describe('TEST-110: Validate JSON-LOGIC-PATTERNS.MD - Legacy Quest State (Pattern 15)', () => {
    ...
    describe('AC1: Pattern 15 - Quest Active Check (in)', () => {
        ...
        const rule = {
            'in': [questIdToCheck, {'var': `actor.components.${questLogComponentId}.active_quests`}]
        };
        ...
        test('should evaluate TRUE when quest IS in active_quests array', () => {
            ...
            expect(mockEntityManager.getComponentData).toHaveBeenCalledWith(actorId, questLogComponentId);
        });
    ...
    describe('AC2: Pattern 15 - Quest Not Completed Check (! in)', () => {
        ...
        const rule = {
            '!': {'in': [questIdToCheck, {'var': `actor.components.${questLogComponentId}.completed_quests`}]}
        };
