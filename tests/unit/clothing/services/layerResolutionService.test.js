...
describe('LayerResolutionService', () => {
  ...
  describe('resolveAndValidateLayer', () => {
    ...
    it('should return validation error when resolved layer not allowed', () => {
      ...
      expect(result).toEqual({
        layer: 'armor',
        isValid: false,
        error: "Layer 'armor' is not allowed. Allowed layers: [underwear, base]",
      });
    });
  ...
  describe('edge cases and error handling', () => {
    ...
    it('should handle special characters in layer names', () => {
      ...
      expect(service.validateLayerAllowed('under_wear', allowedLayers)).toBe(true);
      expect(service.validateLayerAllowed('base-layer', allowedLayers)).toBe(true);
      expect(service.validateLayerAllowed('outer.armor', allowedLayers)).toBe(true);
    });
  });
});