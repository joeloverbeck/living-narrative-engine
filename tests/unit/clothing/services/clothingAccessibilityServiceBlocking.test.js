  ...
  describe('Removal Blocking Integration', () => {
    it('should filter out pants when belt is equipped', () => {
      ...
      mockEntityManager.hasComponent.mockImplementation((entityId, componentId) => {
        return entityId === 'belt1' && componentId === 'clothing:blocks_removal';
      });
      ...
      mockEntityManager.getComponentData.mockImplementation((entityId, componentId) => {
        ...
        if (entityId === 'belt1' && componentId === 'clothing:blocks_removal') {
          return {
            blockedSlots: [
              {
                slot: 'legs',
      ...
      // Act
      const accessible = service.getAccessibleItems('actor1', { mode: 'topmost' });
    ...
    it('should handle multiple blocking items', () => {
      ...
      mockEntityManager.getComponentData.mockImplementation((entityId, componentId) => {
        ...
        if (entityId === 'suspenders1' && componentId === 'clothing:wearable') {
          return {
            layer: 'accessories',
        ...
        if (entityId === 'suspenders1' && componentId === 'clothing:blocks_removal') {
          return {
            blockedSlots: [
              {
                slot: 'legs',
    ...
    it('should handle armor blocking base layers', () => {
      ...
      mockEntityManager.getComponentData.mockImplementation((entityId, componentId) => {
        ...
        if (entityId === 'cuirass1' && componentId === 'clothing:blocks_removal') {
          return {
            blockedSlots: [
              {
                slot: 'torso_upper',
      ...
      mockEntityManager.hasComponent.mockImplementation((entityId, componentId) => {
        return entityId === 'cuirass1' && componentId === 'clothing:blocks_removal';
      });
    ...
    it('should handle explicit item ID blocking', () => {
      ...
      mockEntityManager.getComponentData.mockImplementation((entityId, componentId) => {
        ...
        if (entityId === 'artifact2' && componentId === 'clothing:blocks_removal') {
          return {
      ...
      mockEntityManager.hasComponent.mockImplementation((entityId, componentId) => {
        return entityId === 'artifact2' && componentId === 'clothing:blocks_removal';
      });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle null wearable component', () => {
      ...
      mockEntityManager.getComponentData.mockImplementation((entityId, componentId) => {
        ...
        if (entityId === 'invalid-item' && componentId === 'clothing:wearable') {
          return null;
        }
