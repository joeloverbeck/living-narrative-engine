...
describe('UnifiedCache', () => {
  ...
  beforeEach(() => {
    ...
    cache = new UnifiedCache({ logger: mockLogger }, {
      maxSize: 5,
      ttl: 1000,
  ...
  describe('Construction and Configuration', () => {
    it('should create cache with default configuration', () => {
      ...
      expect(defaultCache.getMetrics().config.evictionPolicy).toBe(EvictionPolicy.LRU);
    });

    it('should create cache with custom configuration', () => {
      const customCache = new UnifiedCache({ logger: mockLogger }, {
        maxSize: 100,
        ttl: 5000,
    ...
    it('should throw error for invalid eviction policy', () => {
      expect(() => {
        new UnifiedCache({ logger: mockLogger }, {
  ...
  describe('Metrics and Statistics', () => {
    ...
    it('should not track stats when metrics are disabled', () => {
      const noMetricsCache = new UnifiedCache({ logger: mockLogger }, {
        enableMetrics: false,
      });
  ...
  describe('Memory Usage Tracking', () => {
    ...
    it('should calculate utilization percentage when max memory is set', () => {
      const memoryCache = new UnifiedCache({ logger: mockLogger }, {
  ...
  describe('Pruning Operations', () => {
    it('should prune expired entries', (done) => {
      const shortTtlCache = new UnifiedCache({ logger: mockLogger }, {
        ttl: 50,
        enableMetrics: true,
      });
