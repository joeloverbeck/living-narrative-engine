...
describe('ContextValidator', () => {
  ...
  describe('validate', () => {
    ...
    it('should throw error for null context', () => {
      expect(() => contextValidator.validate(null)).toThrow('[CRITICAL] Context must be a valid object');
    });

    it('should throw error for undefined context', () => {
      expect(() => contextValidator.validate(undefined)).toThrow('[CRITICAL] Context must be a valid object');
    });

    it('should throw error for non-object context', () => {
      expect(() => contextValidator.validate('not an object')).toThrow('[CRITICAL] Context must be a valid object');
      expect(() => contextValidator.validate(123)).toThrow('[CRITICAL] Context must be a valid object');
      expect(() => contextValidator.validate([])).toThrow('[CRITICAL] Context is missing required properties');
    });
    ...
    it('should throw error for missing actorEntity', () => {
      ...
      expect(() => contextValidator.validate(contextWithoutActor))
    ...
    it('should throw error for missing runtimeCtx', () => {
      ...
      expect(() => contextValidator.validate(contextWithoutRuntime))
    ...
    it('should throw error for missing dispatcher', () => {
      ...
      expect(() => contextValidator.validate(contextWithoutDispatcher))
    ...
    it('should throw error for missing multiple properties', () => {
      ...
      expect(() => contextValidator.validate(contextWithoutMultiple))
        .toThrow('[CRITICAL] Context is missing required properties: actorEntity, dispatcher');
    });
    ...
    it('should throw error for actorEntity without id', () => {
      ...
      expect(() => contextValidator.validate(contextWithInvalidActor))
    ...
    it('should throw error for non-object runtimeCtx', () => {
      ...
      expect(() => contextValidator.validate(contextWithInvalidRuntime))
    ...
    it('should throw error for dispatcher without resolve method', () => {
      ...
      expect(() => contextValidator.validate(contextWithInvalidDispatcher))
    ...
    it('should throw error for invalid depth', () => {
      ...
      expect(() => contextValidator.validate(contextWithInvalidDepth))
    ...
    it('should throw error for cycleDetector without required methods', () => {
      ...
      expect(() => contextValidator.validate(contextWithInvalidCycleDetector))
    ...
    it('should throw error for depthGuard without ensure method', () => {
      ...
      expect(() => contextValidator.validate(contextWithInvalidDepthGuard))
    ...
    it('should allow undefined depth', () => {
      ...
      expect(() => contextValidator.validate(contextWithUndefinedDepth)).not.toThrow();
    });
    ...
    it('should allow zero depth', () => {
      ...
      expect(() => contextValidator.validate(contextWithZeroDepth)).not.toThrow();
    });
  });

  describe('validateForMerging', () => {
    it('should validate base context fully', () => {
      expect(() => contextValidator.validateForMerging(validContext, null)).not.toThrow();
    });
    ...
    it('should allow undefined overlay context', () => {
      expect(() => contextValidator.validateForMerging(validContext, undefined)).not.toThrow();
    });

    it('should validate overlay context when provided', () => {
      const validOverlay = { depth: 1, customProp: 'test' };
      expect(() => contextValidator.validateForMerging(validContext, validOverlay)).not.toThrow();
    });
    ...
    it('should throw error for invalid base context', () => {
      ...
      expect(() => contextValidator.validateForMerging(invalidBase, null))
        .toThrow('[CRITICAL] Context is missing required properties: actorEntity');
    });
    ...
    it('should throw error for invalid overlay context', () => {
      ...
      expect(() => contextValidator.validateForMerging(validContext, invalidOverlay))
        .toThrow('[CRITICAL] actorEntity must have an id property');
    });
  });
  ...
  describe('_validatePartialContext', () => {
    it('should throw error for non-object context', () => {
      expect(() => contextValidator._validatePartialContext('not an object'))
    ...
    it('should validate actorEntity when present', () => {
      ...
      expect(() => contextValidator._validatePartialContext(partialContext))
        .toThrow('[CRITICAL] actorEntity must have an id property');
    });
    ...
    it('should not throw for valid partial context', () => {
      ...
      expect(() => contextValidator._validatePartialContext(validPartialContext)).not.toThrow();
    });
  ...
  describe('_findMissingCriticalProperties', () => {
    it('should return empty array for context with all properties', () => {
      const missing = contextValidator._findMissingCriticalProperties(validContext);
    ...
    it('should return missing properties', () => {
      ...
      const missing = contextValidator._findMissingCriticalProperties(contextWithMissing);
    ...
    it('should work with custom critical properties', () => {
      ...
      const missing = customValidator._findMissingCriticalProperties(contextWithCustom);
  ...
  describe('hasAllCriticalProperties', () => {
    it('should return true for context with all properties', () => {
      expect(contextValidator.hasAllCriticalProperties(validContext)).toBe(true);
    });
    ...
    it('should return false for context missing properties', () => {
      ...
      expect(contextValidator.hasAllCriticalProperties(contextWithMissing)).toBe(false);
    });
  });
  ...
  describe('withCriticalProperties', () => {
    it('should create validator with custom properties', () => {
      ...
      const customValidator = ContextValidator.withCriticalProperties(customProperties);
      
      expect(customValidator.getCriticalProperties()).toEqual(customProperties);
    });

    it('should create independent validator instance', () => {
      const customValidator = ContextValidator.withCriticalProperties(['custom1']);
  ...
  describe('edge cases', () => {
    it('should handle context with null properties', () => {
      ...
      expect(() => contextValidator.validate(contextWithNulls))
        .toThrow('[CRITICAL] Context is missing required properties: actorEntity, runtimeCtx');
    });
    ...
    it('should handle context with undefined properties', () => {
      ...
      expect(() => contextValidator.validate(contextWithUndefined))
        .toThrow('[CRITICAL] Context is missing required properties: actorEntity, dispatcher');
    });
    ...
    it('should handle dispatcher with resolve as non-function', () => {
      ...
      expect(() => contextValidator.validate(contextWithInvalidResolve))
        .toThrow('[CRITICAL] dispatcher must have a resolve method');
    });
    ...
    it('should handle cycleDetector with partial methods', () => {
      ...
      expect(() => contextValidator.validate(contextWithPartialCycleDetector))
        .toThrow('[CRITICAL] cycleDetector must have enter and leave methods');
    });
  });
});