  ...
  describe('Basic Container Operations', () => {
    describe('register()', () => {
      ...
      it('should register a service with explicit lifecycle options', () => {
        const value = { test: 'value' };
        container.register('testKey', value, { lifecycle: 'transient', tags: ['tag1'] });
      ...
      it('should clear existing singleton instance when re-registering singletonFactory', () => {
        ...
        container.register('testKey', factory1, { lifecycle: 'singletonFactory' });
        const instance1 = container.resolve('testKey');
        
        container.register('testKey', factory2, { lifecycle: 'singletonFactory' });
        const instance2 = container.resolve('testKey');
    ...
    describe('resolve()', () => {
      ...
      it('should resolve singletonFactory instances consistently', () => {
        ...
        container.register('testKey', factory, { lifecycle: 'singletonFactory' });
      ...
      it('should throw error for unknown lifecycle', () => {
        ...
        testContainer.resolve = function(key) {
          ...
          if (registrationKey === 'testKey') {
            ...
            const registration = { registration: 'value', options: { lifecycle: 'unknown' } };
            const { registration: factoryOrValueOrClass, options } = registration;
            const lifecycle = options.lifecycle || 'singleton';
            
            if (lifecycle !== 'singleton' && lifecycle !== 'singletonFactory' && lifecycle !== 'transient') {
              throw new Error(
      ...
      it('should handle singleton creation errors and log them', () => {
        const throwingFactory = () => { throw new Error('Creation failed'); };
        container.register('testKey', throwingFactory, { lifecycle: 'singleton' });
      ...
      it('should handle transient creation errors and log them', () => {
        const throwingFactory = () => { throw new Error('Creation failed'); };
        container.register('testKey', throwingFactory, { lifecycle: 'transient' });
  ...
  describe('Tag-based Resolution', () => {
    describe('resolveByTag()', () => {
      ...
      it('should handle resolution errors gracefully and log them', () => {
        ...
        const throwingFactory = () => { throw new Error('Resolution failed'); };
