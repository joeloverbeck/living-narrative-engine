...
describe('JSON-Schema – core component data contracts', () => {
  ...
  const validPayloads = {
    ...
    'anatomy:sensory': { vision: true, acuity: 'acute' },
    'anatomy:suckered': { rows: 2, adhesion: 'strong' },
    'anatomy:crushing': { biteForce: 'titanic' },
    'anatomy:ink_reservoir': { capacity: 'massive', pressure: 'high' },
  ...
  const invalidPayloads = {
    ...
    'anatomy:sensory': { vision: 'not-a-boolean' },
    'anatomy:suckered': { rows: -1 },
    'anatomy:crushing': { biteForce: 'invalid_value' },
    'anatomy:ink_reservoir': { capacity: 'massive' },
    'core:owned_by': {},
