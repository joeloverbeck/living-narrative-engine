...
import engineVersionSatisfies from '../../../src/engine/engineVersionSatisfies.js';
...
describe('engineVersionSatisfies Utility', () => {
  ...
  describe('Input Validation Errors (Throws TypeError)', () => {
    it('should throw TypeError for null input', () => {
      expect(() => engineVersionSatisfies(null)).toThrow(
        new TypeError('Missing or empty version range provided.')
      );
    });

    it('should throw TypeError for undefined input', () => {
      expect(() => engineVersionSatisfies(undefined)).toThrow(
        new TypeError('Missing or empty version range provided.')
      );
    });

    it('should throw TypeError for empty string input', () => {
      expect(() => engineVersionSatisfies('')).toThrow(
        new TypeError('Missing or empty version range provided.')
      );
    });
    ...
    it('should throw TypeError for a nonsense string input ("invalid-range")', () => {
      ...
      expect(() => engineVersionSatisfies(invalidRange)).toThrow(
        new TypeError(`Invalid SemVer range provided: "${invalidRange}".`)
      );
    });
    ...
    it('should throw TypeError for non-string input (number)', () => {
      expect(() => engineVersionSatisfies(123)).toThrow(
        new TypeError('Invalid SemVer range provided: "123".')
      );
    });

    it('should throw TypeError for non-string input (boolean)', () => {
      expect(() => engineVersionSatisfies(true)).toThrow(
        new TypeError('Invalid SemVer range provided: "true".')
      );
    });
    ...
    it('should throw TypeError for non-string input (object)', () => {
      ...
      expect(() => engineVersionSatisfies(obj)).toThrow(
        new TypeError(expectedMsg)
      );
    });
    ...
    it('should throw TypeError for non-string input (array)', () => {
      ...
      expect(() => engineVersionSatisfies(arr)).toThrow(
        new TypeError(expectedMsg)
      );
    });
  });
