...
describe('ComponentStateValidator', () => {
  ...
  describe('Constructor', () => {
    it('should validate logger dependency', () => {
      expect(() => new ComponentStateValidator({ logger: null }))
    ...
    it('should require logger with required methods', () => {
      ...
      expect(() => new ComponentStateValidator({ logger: invalidLogger }))
    ...
    it('should create validator with valid logger', () => {
      ...
      expect(() => new ComponentStateValidator({ logger: validLogger }))
        .not.toThrow();
    });
  });
  ...
  describe('validateFurnitureComponent', () => {
    describe('Valid cases', () => {
      it('should validate furniture with valid spots', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:chair', component))
          .not.toThrow();
      ...
      it('should validate furniture with custom context', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:chair', component, 'sitting operation'))
          .not.toThrow();
        expect(mockLogger.debug).toHaveBeenCalledWith(
          'Furniture component validated',
      ...
      it('should validate furniture with single spot', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:stool', component))
          .not.toThrow();
      });
      ...
      it('should validate furniture with maximum spots', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:bench', component))
          .not.toThrow();
      });
      ...
      it('should validate furniture with mixed occupied and empty spots', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:table', component))
          .not.toThrow();
      });
    });
    ...
    describe('Parameter validation', () => {
      it('should require non-blank furniture ID', () => {
        ...
        expect(() => validator.validateFurnitureComponent('', component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateFurnitureComponent(null, component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateFurnitureComponent('   ', component))
          .toThrow(InvalidArgumentError);
      });
      ...
      it('should require non-blank context', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:chair', component, ''))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateFurnitureComponent('core:chair', component, null))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateFurnitureComponent('core:chair', component, '   '))
          .toThrow(InvalidArgumentError);
      });
    ...
    describe('Component validation errors', () => {
      it('should throw EntityNotFoundError for missing component', () => {
        expect(() => validator.validateFurnitureComponent('core:chair', null))
          .toThrow(EntityNotFoundError);
        expect(() => validator.validateFurnitureComponent('core:chair', null))
          .toThrow('Furniture core:chair missing allows_sitting component');
        
        expect(() => validator.validateFurnitureComponent('core:chair', undefined))
          .toThrow(EntityNotFoundError);
      });
      ...
      it('should throw InvalidArgumentError for exceeding maximum spots', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:longbench', component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateFurnitureComponent('core:longbench', component))
    ...
    describe('Spot validation errors', () => {
      it('should throw InvalidArgumentError for invalid occupant ID format', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:chair', component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateFurnitureComponent('core:chair', component))
          .toThrow('Furniture core:chair spot 1 has invalid occupant ID: invalid-id-no-colon');
      });
      ...
      it('should throw InvalidArgumentError for object occupant ID', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:chair', component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateFurnitureComponent('core:chair', component))
          .toThrow('Furniture core:chair spot 1 has invalid occupant ID: [object Object]');
      });
      ...
      it('should validate correct spot index in error messages', () => {
        ...
        expect(() => validator.validateFurnitureComponent('core:chair', component))
          .toThrow('Furniture core:chair spot 2 has invalid occupant ID: invalid-id');
      });
    });
    ...
    describe('Error logging', () => {
      it('should log error details on validation failure', () => {
        ...
        try {
          validator.validateFurnitureComponent('core:chair', component, 'test context');
        } catch {
          // Expected to throw
        }
  ...
  describe('validateClosenessComponent', () => {
    describe('Valid cases', () => {
      it('should allow null closeness component', () => {
        expect(() => validator.validateClosenessComponent('core:actor1', null))
          .not.toThrow();
      ...
      it('should validate component with partners', () => {
        ...
        expect(() => validator.validateClosenessComponent('core:actor1', component))
          .not.toThrow();
        expect(mockLogger.debug).toHaveBeenCalledWith(
      ...
      it('should validate component with custom context', () => {
        ...
        expect(() => validator.validateClosenessComponent('core:actor1', component, 'relationship setup'))
          .not.toThrow();
        expect(mockLogger.debug).toHaveBeenCalledWith(
          'Closeness component validated',
      ...
      it('should validate component with different namespaced partners', () => {
        const component = { partners: ['core:actor2', 'mod:npc1', 'custom:character3'] };
    ...
    describe('Parameter validation', () => {
      it('should require non-blank actor ID', () => {
        ...
        expect(() => validator.validateClosenessComponent('', component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateClosenessComponent(null, component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateClosenessComponent('   ', component))
          .toThrow(InvalidArgumentError);
      });
      ...
      it('should require non-blank context', () => {
        ...
        expect(() => validator.validateClosenessComponent('core:actor1', component, ''))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateClosenessComponent('core:actor1', component, null))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateClosenessComponent('core:actor1', component, '   '))
          .toThrow(InvalidArgumentError);
      });
    ...
    describe('Partner validation errors', () => {
      it('should throw InvalidArgumentError for invalid partner ID format', () => {
        ...
        expect(() => validator.validateClosenessComponent('core:actor1', component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateClosenessComponent('core:actor1', component))
          .toThrow('Actor core:actor1 has invalid partner ID at index 1: invalid-id-no-colon');
      });
      ...
      it('should validate correct partner index in error messages', () => {
        const component = { partners: ['core:valid', 'core:valid2', 'invalid-id'] };
        
        expect(() => validator.validateClosenessComponent('core:actor1', component))
          .toThrow('Actor core:actor1 has invalid partner ID at index 2: invalid-id');
      });

      it('should throw InvalidArgumentError for duplicate partners', () => {
        const component = { partners: ['core:actor2', 'core:actor3', 'core:actor2'] };
        
        expect(() => validator.validateClosenessComponent('core:actor1', component))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateClosenessComponent('core:actor1', component))
          .toThrow('Actor core:actor1 has duplicate partners in closeness component');
      });
    ...
    describe('Error logging', () => {
      it('should log error details on validation failure', () => {
        ...
        try {
          validator.validateClosenessComponent('core:actor1', component, 'test context');
        } catch {
          // Expected to throw
        }
        ...
        expect(mockLogger.error).toHaveBeenCalledWith(
          ...
          expect.objectContaining({
            error: 'Actor core:actor1 has invalid partner ID at index 0: invalid-id',
            context: 'test context'
          })
        );
      });
  ...
  describe('validateBidirectionalCloseness', () => {
    ...
    beforeEach(() => {
      mockEntityManager = testBed.createMock('EntityManager', ['getComponentData']);
    });
    ...
    describe('Valid cases', () => {
      it('should validate bidirectional relationships', () => {
        ...
        expect(() => validator.validateBidirectionalCloseness(
          mockEntityManager, 'core:actor1', 'core:actor2'
        )).not.toThrow();
    ...
    describe('Parameter validation', () => {
      it('should require non-blank actor ID', () => {
        expect(() => validator.validateBidirectionalCloseness(mockEntityManager, '', 'core:actor2'))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateBidirectionalCloseness(mockEntityManager, null, 'core:actor2'))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateBidirectionalCloseness(mockEntityManager, '   ', 'core:actor2'))
          .toThrow(InvalidArgumentError);
      });
      ...
      it('should require non-blank partner ID', () => {
        expect(() => validator.validateBidirectionalCloseness(mockEntityManager, 'core:actor1', ''))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateBidirectionalCloseness(mockEntityManager, 'core:actor1', null))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateBidirectionalCloseness(mockEntityManager, 'core:actor1', '   '))
          .toThrow(InvalidArgumentError);
      });
      ...
      it('should require entity manager', () => {
        expect(() => validator.validateBidirectionalCloseness(null, 'core:actor1', 'core:actor2'))
          .toThrow(InvalidArgumentError);
        expect(() => validator.validateBidirectionalCloseness(null, 'core:actor1', 'core:actor2'))
    ...
    describe('Unidirectional relationship detection', () => {
      it('should detect unidirectional relationships (A→B but not B→A)', () => {
        ...
        expect(() => validator.validateBidirectionalCloseness(
          mockEntityManager, 'core:actor1', 'core:actor2'
        )).toThrow('Unidirectional closeness detected: core:actor1 → core:actor2 but not reverse');
      });
      ...
      it('should detect unidirectional relationships (B→A but not A→B)', () => {
        ...
        expect(() => validator.validateBidirectionalCloseness(
          mockEntityManager, 'core:actor1', 'core:actor2'
        )).toThrow('Unidirectional closeness detected: core:actor2 → core:actor1 but not reverse');
      });
    ...
    describe('Entity manager interaction', () => {
      it('should call getComponentData with correct parameters', () => {
        ...
        validator.validateBidirectionalCloseness(mockEntityManager, 'core:actor1', 'core:actor2');

        expect(mockEntityManager.getComponentData).toHaveBeenCalledTimes(2);
        expect(mockEntityManager.getComponentData).toHaveBeenCalledWith('core:actor1', 'positioning:closeness');
        expect(mockEntityManager.getComponentData).toHaveBeenCalledWith('core:actor2', 'positioning:closeness');
      });
    });
    ...
    describe('Error logging', () => {
      it('should log error details on validation failure', () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith(
          ...
          expect.objectContaining({
            error: 'Unidirectional closeness detected: core:actor1 → core:actor2 but not reverse'
          })
        );
      });
    });
