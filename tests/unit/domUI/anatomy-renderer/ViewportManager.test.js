...
describe('ViewportManager', () => {
  ...
  describe('Zoom Operations', () => {
    ...
    it('should maintain center point during zoom', () => {
      ...
      const screenCenterAfter = viewportManager.worldToScreen(worldCenterBefore.x, worldCenterBefore.y);
  ...
  describe('Coordinate Conversion', () => {
    ...
    it('should handle coordinate conversion with zoom', () => {
      ...
      const worldY = 200;
      const screenCoords = viewportManager.worldToScreen(worldX, worldY);
      const backToWorld = viewportManager.screenToWorld(screenCoords.x, screenCoords.y);
