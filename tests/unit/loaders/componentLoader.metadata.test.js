...
describe('ComponentLoader - metadata field validation', () => {
  ...
  describe('Component schema validation', () => {
    ...
    it('should fail validation when component contains metadata field', () => {
      ...
      // Register the schema
      validator.addSchema(componentSchema, 'schema://living-narrative-engine/component.schema.json');

      // Validate
      const result = validator.validate('schema://living-narrative-engine/component.schema.json', componentWithMetadata);
    ...
    it('should pass validation when component does not contain metadata field', () => {
          ...
          "items": {
            ...
            "properties": {
              ...
              "blocker": {
                ...
                "pattern": "^[a-z][a-z0-9_]*:[a-z][a-z0-9_]*$",
                "default": null,
                "description": "Optional namespaced ID of an entity blocking this exit"
              }
            },
            "additionalProperties": false
          },
      ...
      // Validate
      const result = validator.validate('schema://living-narrative-engine/component.schema.json', componentWithoutMetadata);
    ...
    it('should fail validation with exact error message from log', () => {
      ...
      // Validate
      const result = validator.validate('schema://living-narrative-engine/component.schema.json', movementComponent);
