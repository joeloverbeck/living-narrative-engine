...
import { createMockLogger, createEventBus } from '../../../common/mockFactories/index.js';
...
describe('CharacterBuilderService - Thematic Directions Methods', () => {
  ...
  beforeEach(async () => {
    ...
    mockDependencies = {
      ...
      storageService: {
        ...
        getCharacterConcept: jest.fn().mockResolvedValue({ id: 'concept1', title: 'Test Concept' }),
  ...
  describe('Method Availability Verification', () => {
    it('should verify that getAllThematicDirections method DOES exist', () => {
      ...
      expect(typeof characterBuilderService.getAllThematicDirections).toBe('function');
    });

    it('should verify that getAllThematicDirectionsWithConcepts method DOES exist', () => {
      // Act & Assert: The actual method should exist
      expect(typeof characterBuilderService.getAllThematicDirectionsWithConcepts).toBe('function');
    });
    ...
    it('should demonstrate that both thematic direction methods work correctly', async () => {
      ...
      const allDirections = await characterBuilderService.getAllThematicDirections();
      ...
      const directionsWithConcepts = await characterBuilderService.getAllThematicDirectionsWithConcepts();
    ...
    it('should verify TraitsGeneratorController can call getAllThematicDirections successfully', async () => {
      ...
      expect(typeof characterBuilderService[methodUsedByController]).toBe('function');
