...
describe('CharacterBuilderService - Method Existence Verification', () => {
  it('should have getAllThematicDirections method on the prototype', async () => {
    ...
    expect(typeof CharacterBuilderService.prototype.getAllThematicDirections).toBe('function');
  });
  ...
  it('should have getAllThematicDirectionsWithConcepts method on the prototype', async () => {
    ...
    expect(typeof CharacterBuilderService.prototype.getAllThematicDirectionsWithConcepts).toBe('function');
  });
  ...
  it('should verify that both methods exist and are different', async () => {
    ...
    expect(CharacterBuilderService.prototype.getAllThematicDirections).toBeDefined();
    expect(CharacterBuilderService.prototype.getAllThematicDirectionsWithConcepts).toBeDefined();
  ...
  it('should verify that TraitsDisplayEnhancer can be imported', async () => {
    ...
    const { TraitsDisplayEnhancer } = await import('../../../../src/characterBuilder/services/TraitsDisplayEnhancer.js');
    
    // Act & Assert: Class should be importable and be a constructor function
    expect(typeof TraitsDisplayEnhancer).toBe('function');
    expect(TraitsDisplayEnhancer.prototype.constructor).toBe(TraitsDisplayEnhancer);
  });
});