...
describe('Thematic Direction - Schema Registration', () => {
  ...
  it('should simulate proper schema registration pattern', async () => {
    ...
    expect(schemaValidator.isSchemaLoaded('thematic:character_concept_created#payload')).toBe(true);
    expect(schemaValidator.isSchemaLoaded('thematic:thematic_directions_generated#payload')).toBe(true);
  });
