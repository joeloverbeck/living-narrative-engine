...
describe('NotesCompatibilityService', () => {
  ...
  describe('detectNoteFormat', () => {
    ...
    test('should detect legacy object format', () => {
      ...
      expect(
        service.detectNoteFormat({ text: 'Note', timestamp: '2024-01-15' })
      ).toBe('legacy');
    });

    test('should detect structured format', () => {
      expect(
        service.detectNoteFormat({
          text: 'Note text',
          subject: 'John',
        })
      ).toBe('structured');
  ...
  describe('convertToFormat', () => {
    test('should convert string to structured', () => {
      const result = service.convertToFormat(
        'John seems nervous',
        'structured'
      );
    ...
    test('should not convert if already in target format', () => {
      ...
      expect(service.convertToFormat(structured, 'structured')).toBe(
        structured
      );
  ...
  describe('ensureFormat', () => {
    ...
    test('should convert all notes to legacy format', () => {
      const mixed = ['String note', { text: 'Structured', subject: 'John' }];
  ...
  describe('mergeNotes', () => {
    ...
    test('should handle empty and invalid arrays', () => {
      const result = service.mergeNotes([
        [],
        null,
        'not array',
        [{ text: 'Valid' }],
