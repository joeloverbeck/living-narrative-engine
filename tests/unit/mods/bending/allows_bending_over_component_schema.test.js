/**
 * @file Unit tests for the bending:allows_bending_over component schema validation
 * @description Tests that the component schema correctly validates as a simple marker component
 */

import { describe, it, expect, beforeAll } from '@jest/globals';

describe('bending:allows_bending_over component schema validation', () => {
  let componentSchema;

  beforeAll(async () => {
    const component = await import(
      '../../../../data/mods/bending/components/allows_bending_over.component.json',
      { with: { type: 'json' } }
    );
