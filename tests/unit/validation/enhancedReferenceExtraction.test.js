...
describe('ModReferenceExtractor - Enhanced Context Extraction', () => {
  ...
  "actions": [
    {
      ...
      const closeToTargetComponent = positioningComponents.find(
        (c) => c.componentId === 'close_to_target'
      );
  ...
  describe('Context Snippet Creation', () => {
    it('should create appropriate snippets with ellipsis for long lines', async () => {
      ...
      const longLine =
        '"very_long_property_name_that_goes_on_and_on": "test:component_with_very_long_name_here"';
      const content = `{\n  ${longLine}\n}`;
      fs.readFile.mockResolvedValue(content);
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    it('should handle empty directories', async () => {
      ...
      const result =
        await extractor.extractReferencesWithFileContext('/test/empty-mod');
    ...
    it('should handle nested directory structures', async () => {
      ...
      const content =
        '{"required_components": {"actor": ["nested:component"]}}';
      fs.readFile.mockResolvedValue(content);
