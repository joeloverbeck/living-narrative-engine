 ...
 * 1. `createMultiTargetTestContext` - NEW: Uses real production services via e2eTestContainer
 * 2. `MultiTargetTestBuilder` class - LEGACY: Uses mock facades (for unmigrated tests)
 *
 * New tests should use `createMultiTargetTestContext`. The legacy class is maintained
 * for backward compatibility with tests that haven't been migrated yet.
 */
...
/**
 * Factory function to create a new test builder (LEGACY - for unmigrated tests)
 *
 * @param {object} jest - Jest object with fn and spyOn methods
 * @returns {MultiTargetTestBuilder} New test builder instance
 * @deprecated Use createMultiTargetTestContext for new tests
 */
