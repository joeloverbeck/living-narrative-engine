...
describe('Complete Event Lifecycle E2E Test', () => {
  ...
  beforeEach(async () => {
    ...
    eventSchemas = {
      [ENTITY_CREATED_ID]: { id: ENTITY_CREATED_ID, description: 'Entity created event' },
      [COMPONENT_ADDED_ID]: { id: COMPONENT_ADDED_ID, description: 'Component added event' },
      [SYSTEM_ERROR_OCCURRED_ID]: { id: SYSTEM_ERROR_OCCURRED_ID, description: 'System error event' }
    };
  ...
  describe('Complex Event Chains', () => {
    ...
    it('should handle turn-based event sequencing', async () => {
      ...
      await eventBus.dispatch(TURN_STARTED_ID, { turnNumber: 1, activeEntityId: 'player' });
      ...
      await eventBus.dispatch(TURN_ENDED_ID, { turnNumber: 1, activeEntityId: 'player' });
