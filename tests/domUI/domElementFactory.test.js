...
/**
 * @file Unit tests for DomElementFactory using Jest and JSDOM.
 * @jest-environment jsdom
 */

import { beforeEach, describe, expect, it, jest } from '@jest/globals';
import DocumentContext from '../../src/domUI/documentContext.js'; // Use the real DocumentContext
...
describe('DomElementFactory', () => {
  ...
  describe('img()', () => {
    ...
    it('should create an img with src, alt, and classes', () => {
      const el = factory.img('path/to/avatar.jpg', 'User Avatar', [
        'avatar',
        'rounded',
      ]);
      expect(el).toBeInstanceOf(HTMLImageElement);
  ...
  describe('create()', () => {
    ...
    it('should not set null or undefined attributes', () => {
      const el = factory.create('div', {
        attrs: { defined: 'yes', 'is-null': null, 'is-undefined': undefined },
      });
