 ...
 * - id: Unique identifier (e.g., "personal-space-states:close_actors")
...
class BaseScopeResolver {
   ...
   * @param {string} config.id - Unique identifier for this scope (e.g., "personal-space-states:close_actors")
