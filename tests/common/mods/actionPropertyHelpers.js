 ...
 * });
 */
export function validateVisualStyling(visual, styleName, expectedColors = null) {
 ...
 * });
 */
export function validateComponentRequirements(action, expected = { required: {}, forbidden: {} }) {
 ...
 */
export function validateRequiredActionProperties(action, additionalRequired = []) {
