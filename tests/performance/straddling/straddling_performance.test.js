...
import straddleFacingRule from '../../../data/mods/straddling/rules/straddle_waist_facing.rule.json';
import straddleFacingAwayRule from '../../../data/mods/straddling/rules/straddle_waist_facing_away.rule.json';
import dismountRule from '../../../data/mods/straddling/rules/dismount_from_straddling.rule.json';
import straddleFacingCondition from '../../../data/mods/straddling/conditions/event-is-action-straddle-waist-facing.condition.json';
import straddleFacingAwayCondition from '../../../data/mods/straddling/conditions/event-is-action-straddle-waist-facing-away.condition.json';
import dismountCondition from '../../../data/mods/straddling/conditions/event-is-action-dismount-from-straddling.condition.json';
  ...
  describe('Rule execution performance', () => {
    ...
    it('should handle facing away variant with same performance', () => {
      ...
      const event = {
        ...
        payload: {
          action: {
            id: 'straddling:straddle_waist_facing_away',
            actorId: 'test:actor1',
            target: 'test:target',
          },
        },
