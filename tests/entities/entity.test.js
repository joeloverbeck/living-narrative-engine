    ...
    describe('constructor', () => {
        ...
        describe('invalid instanceId', () => {
            it.each([
                ...
                expect(() => new Entity(invalidId, validDefinitionId)).toThrow('Entity must have a valid string instanceId.');
            });

            it('should throw an Error if no instanceId is provided (and definitionId is also missing or invalid)', () => {
                expect(() => new Entity()).toThrow('Entity must have a valid string instanceId.');
            });
        });
        ...
        describe('invalid definitionId', () => {
            it.each([
                ...
                expect(() => new Entity(validInstanceId, invalidId)).toThrow('Entity must have a valid string definitionId.');
            });

            it('should throw an Error if only instanceId is provided and definitionId is missing', () => {
                expect(() => new Entity(validInstanceId)).toThrow('Entity must have a valid string definitionId.');
            });
        });
    });
    ...
    describe('addComponent', () => {
        ...
        describe('Edge Cases', () => {
            ...
            it.each([
                ...
                [{}, 'object'],
                [[], 'array'],
            ])('should throw an Error if componentTypeId is %s (%p)', (invalidTypeId) => {
