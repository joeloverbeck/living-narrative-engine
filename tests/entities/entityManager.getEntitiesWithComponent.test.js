...
const createMockSpatialIndexManager = () => ({ // Not directly used by getEntitiesWithComponent
    addEntity: jest.fn(),
...
describe('EntityManager.getEntitiesWithComponent', () => {
    ...
    it('should return an array containing only entities that have the specified component (multiple matches)', () => {
        ...
        expect(resultAIds).toEqual([ENTITY_1_INSTANCE_ID, ENTITY_3_INSTANCE_ID].sort());
        ...
        expect(resultBIds).toEqual([ENTITY_2_INSTANCE_ID, ENTITY_3_INSTANCE_ID].sort());
    ...
    it('should return a new array (not a live reference)', () => {
        ...
        expect(initialResult.map(e => e.id).sort()).toEqual([ENTITY_1_INSTANCE_ID, ENTITY_3_INSTANCE_ID].sort());
        ...
        expect(newResult.map(e => e.id).sort()).toEqual([ENTITY_3_INSTANCE_ID, newEntity4InstanceId].sort());
    });
});