...
describe('ProximityUtils Memory Leak Detection', () => {
  ...
  describe('getAdjacentSpots Memory Usage', () => {
    it('should not create memory leaks in repeated getAdjacentSpots calls', () => {
      ...
      console.log(
        `getAdjacentSpots memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
    ...
    it('should handle memory efficiently across different furniture sizes', () => {
      ...
      console.log(
        `getAdjacentSpots (varied sizes) memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
    ...
    it('should not accumulate memory from result arrays', () => {
      ...
      console.log(
        `getAdjacentSpots (with result storage) memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
  ...
  describe('findAdjacentOccupants Memory Usage', () => {
    it('should not create memory leaks in repeated findAdjacentOccupants calls', () => {
      ...
      console.log(
        `findAdjacentOccupants memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
    ...
    it('should handle large furniture arrays without memory leaks', () => {
      ...
      console.log(
        `findAdjacentOccupants (large furniture) memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
    ...
    it('should not leak memory from result arrays', () => {
      ...
      console.log(
        `findAdjacentOccupants (with result storage) memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
  ...
  describe('validateProximityParameters Memory Usage', () => {
    it('should not create memory leaks in repeated parameter validation', () => {
      ...
      console.log(
        `validateProximityParameters memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
    ...
    it('should handle varying string lengths without memory leaks', () => {
      ...
      console.log(
        `validateProximityParameters (long strings) memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
  ...
  describe('Combined Operations Memory Usage', () => {
    it('should handle realistic workflow without cumulative memory leaks', () => {
      ...
      console.log(
        `Combined operations memory increase: ${(memoryIncrease / 1024).toFixed(2)} KB`
      );
    ...
    it('should maintain stable memory usage across multiple iterations', () => {
      ...
      for (let iteration = 0; iteration < 3; iteration++) {
        ...
        console.log(
          `Iteration ${iteration + 1} memory increase: ${(iterationIncrease / 1024).toFixed(2)} KB`
        );
      }
