...
async function runDebugTest() {
  ...
  console.log('Controller.initialize exists:', typeof testBed.controller?.initialize);
  ...
  console.log('EventBus dispatch calls:', testBed.mockEventBus.dispatch.mock.calls.length);
  if (testBed.mockEventBus.dispatch.mock.calls.length > 0) {
    console.log('First dispatch call:', testBed.mockEventBus.dispatch.mock.calls[0]);
  }
