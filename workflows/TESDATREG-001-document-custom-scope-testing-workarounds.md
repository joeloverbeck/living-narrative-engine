...
[Include complete code examples from the report]
...
2. **Complete working example** from the passing tests:
   ...
   - Include lines 36-68 (manual scope registration)
   - Include the dependency condition loading pattern
...
4. **Common error scenarios**:
   ...
   - "hasPartOfType is not a function" → NOT an issue, custom operators auto-register
...
- `tests/common/mods/scopeResolverHelpers.js` - Available helper methods
...
- [ ] All referenced files and line numbers are accurate
