  ...
  describe('#loadEligibleDirections', () => {
    ...
    it('should filter out directions without clichés', async () => {
      ...
      mockCharacterBuilderService.getAllThematicDirectionsWithConcepts
        .mockResolvedValue(mockData);
      mockCharacterBuilderService.hasClichesForDirection
        .mockImplementation((id) => Promise.resolve(id === 'dir1'));
      
      await controller.loadEligibleDirections();
      
      expect(mockCharacterBuilderService.hasClichesForDirection)
      ...
      const organizedData = [
        {
          ...
          conceptTitle: 'Test',
          directions: [
            { id: 'unique-id-123', title: 'My Direction Title' }
          ]
        }
      ];
  ...
  describe('#organizeDirectionsByConcept', () => {
    it('should group directions by concept', async () => {
      ...
      controller.directionsWithConceptsMap = new Map([
        ['dir1', { direction: directions[0], concept: { id: 'c1', title: 'Concept 1' }}],
        ['dir2', { direction: directions[1], concept: { id: 'c2', title: 'Concept 2' }}],
        ['dir3', { direction: directions[2], concept: { id: 'c1', title: 'Concept 1' }}]
      ]);
    ...
    it('should sort concepts alphabetically', async () => {
      ...
      controller.directionsWithConceptsMap = new Map([
        ['dir1', { direction: directions[0], concept: { id: 'z', title: 'Zebra Concept' }}],
        ['dir2', { direction: directions[1], concept: { id: 'a', title: 'Apple Concept' }}],
        ['dir3', { direction: directions[2], concept: { id: 'm', title: 'Mango Concept' }}]
      ]);
    ...
    it('should sort directions within concepts alphabetically', async () => {
      ...
      controller.directionsWithConceptsMap = new Map([
        ['dir1', { direction: directions[0], concept: { id: 'c1', title: 'Concept' }}],
        ['dir2', { direction: directions[1], concept: { id: 'c1', title: 'Concept' }}],
        ['dir3', { direction: directions[2], concept: { id: 'c1', title: 'Concept' }}]
      ]);
