...
- [x] Empty activity lists handled gracefully
- [x] Circular references and duplicate metadata prevented
- [x] Extremely long descriptions truncated intelligently
- [x] Special characters sanitised through `#resolveEntityName`
- [x] Self-targeting activities use reflexive pronouns when configured
- [x] Missing target entities handled with sanitised fallbacks
- [x] Duplicate activity metadata deduplicated before formatting
- [x] Configuration exposes toggles and limits for edge case handling
- [x] Tests verify all edge cases
- [x] No crashes on unusual inputs
