...
(async () => {
    ...
    try {
        ...
        logger.info(`main.js: Executing ${currentPhaseForError} stage...`);
        if (!gameEngine) { // This check should be redundant if initializeGameEngineStage is robust
        ...
        const errorDetails = {
            ...
            phase: bootstrapError.phase || `Bootstrap Orchestration - ${detectedPhase}` // Prefer specific phase from error
        };
        ...
        displayFatalStartupError(
            uiElements || { // Provide default UI elements if uiElements is undefined
