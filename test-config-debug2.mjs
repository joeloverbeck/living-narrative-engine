...
console.log(
  'Tool calling config modelIdentifier:',
  mockLlmConfig.configs['test-llm-toolcalling'].modelIdentifier
);
console.log(
  'Limited config modelIdentifier:',
  mockLlmConfig.configs['test-llm-limited'].modelIdentifier
);
console.log(
  'Are they different configs?',
  mockLlmConfig.configs['test-llm-toolcalling'] !==
    mockLlmConfig.configs['test-llm-limited']
);
