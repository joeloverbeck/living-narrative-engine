...
3.  **Button Wiring (`uiStages.js`):**
    ...
    *   Add click listener:
        ...
        *   *Refinement from spec:* "Handle promise rejections by sending an inline error event/payload to the modal." -> If the engine method is async and fails *before* dispatching, the UI layer needs to catch that.
