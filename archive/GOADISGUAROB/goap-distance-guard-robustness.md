...
- Extend `goapPlanner.heuristicGuards.test.js` to include a scenario where only the _next_ heuristic estimate sanitizes, proving bypass conditions rely on either side signaling invalidity.
