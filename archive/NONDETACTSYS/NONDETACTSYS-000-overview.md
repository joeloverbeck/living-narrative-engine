...
**Phase 2: Operation Handler (sequential)** 6. NONDETACTSYS-006 (operation schema) 7. NONDETACTSYS-007 (handler implementation) 8. NONDETACTSYS-008 (DI registration)

**Phase 3: Action Discovery (sequential)** 9. NONDETACTSYS-009 (action schema extension) 10. NONDETACTSYS-010 (JSON Logic operator) 11. NONDETACTSYS-011 (ActionFormattingStage)

**Phase 4: Combat Action (after Phase 2 & 3)** 12. NONDETACTSYS-012 (scope definition) 13. NONDETACTSYS-015 (can_cut to weapons - parallelizable with 012) 14. NONDETACTSYS-013 (action definition) 15. NONDETACTSYS-014 (rule definition)

**Phase 5: Enhancement (after Phase 3)** 16. NONDETACTSYS-016 (ModifierCollectorService) 17. NONDETACTSYS-017 (ChanceCalculationService orchestrator)
