...
```json
{
  ...
  "components": {
    "clothing:wearable": { /* layering and slot info */ },
    "core:material": { /* material info */ },
    "core:name": { /* display name */ },
    "core:description": { /* detailed description */ },
    "descriptors:{type}": { /* visual properties */ }
  }
}
```
...
```json
{
  ...
  "values": ["solid", "striped", "polka-dot", "floral", "geometric", "plaid", "animal-print"]
}
```
...
```json
{
  ...
  "values": ["fitted", "loose", "oversized", "tailored", "casual", "formal", "vintage"]
}
```
...
*Analysis covers: 19 clothing entities, 4 descriptor types, 9 clothing slots, 2 additional component types*