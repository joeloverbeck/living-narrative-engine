  ...
  options: {
    ...
    */
    ...
    reporterOptions: {
      dot: {
        collapsePattern: [
          // keep your external deps grouped…
          'node_modules/(?:@[^/]+/[^/]+|[^/]+)',
          // …and collapse each top-level folder in your src into one node
          'src/[^/]+',
        ].join('|'),
        // optionally tweak how the final sub-graphs look
        // (see point 3 for theme details)
      },
      archi: {
...
// generated: dependency-cruiser@16.10.2 on 2025-06-13T14:54:34.827Z
