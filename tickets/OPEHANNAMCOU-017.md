# OPEHANNAMCOU-017: Migrate auto-move closeness handler to shared constants
...
- `NODE_ENV=test npx jest tests/unit/logic/operationHandlers/autoMoveClosenessPartnersHandler.test.js --runInBand --no-coverage`
