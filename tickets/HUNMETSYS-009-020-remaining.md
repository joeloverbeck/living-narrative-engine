...
**Secondary (Core Gameplay):** 5. HUNMETSYS-008, 009, 010 (Actions and food) 6. HUNMETSYS-011, 012, 013 (GOAP integration)

**Tertiary (Enhancement):** 7. HUNMETSYS-015 (Body composition) 8. HUNMETSYS-016 (Energy costs)

**Final (Quality):** 9. HUNMETSYS-017, 018, 019 (Testing) 10. HUNMETSYS-020 (Documentation)
