...
- [ ] `PrototypeSynthesisService` created with deterministic synthesis algorithm.
- [ ] Predicted fit evaluation matches existing prototype evaluation semantics.
- [ ] Unit tests cover name stability, gate ordering, clamp behavior, and fit metrics.
- [ ] No mutation of existing prototypes or contexts.
