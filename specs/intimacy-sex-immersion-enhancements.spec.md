    ...
    "properties": {
      "levels": {
        ...
        "additionalProperties": {
          "type": "object",
          "properties": {
            "physical_comfort": { "type": "number", "minimum": 0, "maximum": 100 },
            "emotional_trust": { "type": "number", "minimum": 0, "maximum": 100 },
            "boundaries": {
              "type": "array",
              "items": { "type": "string" },
...
```json
{
  ...
  "dataSchema": {
    ...
    "properties": {
      "state": {
        "type": "string",
        "enum": ["neutral", "flirty", "romantic", "passionate", "tender", "playful", "nervous", "reluctant"]
      },
      "intensity": {
        "type": "number",
        "minimum": 0,
