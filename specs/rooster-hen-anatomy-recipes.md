...
*   **Slots**:
    ...
    *   *Head Slots*: `beak`, `left_eye`, `right_eye`, `comb`, `wattle`.
    *   *Leg Slots*: `foot`, `spur`.
...
*   (Alternatively, use a shared `chicken.blueprint.json` if the only difference is the *part* filled in the slot, but separate blueprints allow for structural differences like spurs).
