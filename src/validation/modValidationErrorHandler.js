...
class ModValidationErrorHandler {
  ...
  handleExtractionError(error, context) {
    ...
    return this.#applyRecoveryStrategy(strategy, error, context, classification);
  }
  ...
  #determineRecoveryStrategy(classification, context) {
    ...
    switch (classification.type) {
      case ErrorType.ACCESS:
        ...
        return context.hasDefault ? RecoveryStrategy.USE_DEFAULT : RecoveryStrategy.SKIP;
        
      case ErrorType.CORRUPTION:
        // Try partial recovery if possible
        return classification.recoverable ? RecoveryStrategy.PARTIAL_RESULT : RecoveryStrategy.SKIP;
      ...
      case ErrorType.RESOURCE:
        // Resource errors need immediate action
        return RecoveryStrategy.FAIL_FAST;
