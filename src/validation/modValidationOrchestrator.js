...
class ModValidationOrchestrator {
   ...
   * @param {typeof import('../modding/modDependencyValidator.js').default} dependencies.modDependencyValidator
   * @param {import('../validation/modCrossReferenceValidator.js').default} dependencies.modCrossReferenceValidator
   * @param {import('../modding/modLoadOrderResolver.js').default} dependencies.modLoadOrderResolver
   * @param {import('../modding/modManifestLoader.js').default} dependencies.modManifestLoader
