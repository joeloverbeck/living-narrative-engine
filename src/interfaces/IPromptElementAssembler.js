...
/**
 * @fileoverview Defines the IPromptElementAssembler interface.
...
export class IPromptElementAssembler {
    ...
    assemble(elementConfig, promptData, placeholderResolver, allPromptElementsMap) {
        ...
        throw new Error("Method 'assemble(elementConfig, promptData, placeholderResolver, allPromptElementsMap)' must be implemented by concrete classes.");
    }
}
