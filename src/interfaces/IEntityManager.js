...
export class IEntityManager {
  ...
  /**
   * Backwards-compatible alias for getComponentData used by legacy systems
   * and GOAP services.
   *
  ...
  getComponent(instanceId, componentTypeId) {
    throw new Error('IEntityManager.getComponent not implemented.');
  }
  ...
  async batchAddComponentsOptimized(componentSpecs, emitBatchEvent = true) {
    throw new Error(
      'IEntityManager.batchAddComponentsOptimized not implemented.'
    );
  }
