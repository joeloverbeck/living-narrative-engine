...
export class IPromptStaticContentService {
    ...
    getCoreTaskDescriptionText() {
        throw new Error("Method 'getCoreTaskDescriptionText()' must be implemented.");
    }
     ...
     * @returns {string}
     */
    getCharacterPortrayalGuidelines(characterName) { // eslint-disable-line no-unused-vars
        throw new Error("Method 'getCharacterPortrayalGuidelines()' must be implemented.");
    }
    ...
    getFinalLlmInstructionText() {
        throw new Error("Method 'getFinalLlmInstructionText()' must be implemented.");
    }
}
