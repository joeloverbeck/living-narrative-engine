...
export const COPY_ALL_SVG =
  '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><path d="M7.5 4A2.5 2.5 0 0 1 10 1.5h4.5A2.5 2.5 0 0 1 17 4v9.5A2.5 2.5 0 0 1 14.5 16H10A2.5 2.5 0 0 1 7.5 13.5V4z"/><path d="M3 6.5A2.5 2.5 0 0 1 5.5 4H8v1.5H5.5a1 1 0 0 0-1 1V15a1 1 0 0 0 1 1H12a1 1 0 0 0 1-1V13.5h1.5V15A2.5 2.5 0 0 1 12 17.5H5.5A2.5 2.5 0 0 1 3 15V6.5z"/></svg>';

const DEFAULT_ICONS = {
  thoughts: THOUGHT_SVG,
  notes: NOTES_SVG,
  'copy-all': COPY_ALL_SVG,
};
