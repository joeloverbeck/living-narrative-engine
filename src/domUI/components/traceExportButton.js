...
export class TraceExportButton {
  ...
  render(containerId) {
    ...
    wrapper.style.cssText =
      'margin: 10px 0; padding: 10px; border: 1px solid #ccc; border-radius: 4px;';
    ...
    this.#button.style.cssText =
      'padding: 8px 16px; font-size: 14px; cursor: pointer; background: #4CAF50; color: white; border: none; border-radius: 4px;';
    ...
    formatSelector.style.cssText =
      'margin-left: 10px; padding: 8px; font-size: 14px;';
    ...
    this.#progressBar.style.cssText =
      'width: 100%; height: 20px; background: #f0f0f0; border-radius: 4px; overflow: hidden;';
  ...
  async #handleExport() {
    ...
    try {
      ...
      const result =
        await this.#actionTraceOutputService.exportTracesToFileSystem(
          null,
          format
        );
  ...
  #updateProgress(progress) {
    ...
    const progressFill = this.#progressBar.querySelector(
