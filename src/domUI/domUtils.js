...
/**
 * @fileoverview A collection of static utility functions for common DOM operations.
...
export const DomUtils = {
     ...
     * @param {boolean} [allowHtml=false] - If true, `content` is set as HTML using `innerHTML`.
     ...
     * @param {string} [displayStyle='block'] - The CSS display style to apply (e.g., 'block', 'flex', 'inline-block').
     */
