...
import EndTurnSuccessStrategy from '../../../../core/turns/strategies/endTurnSuccessStrategy.js';
...
describe('EndTurnSuccessStrategy', () => {
    ...
    test('should call turnContext.endTurn with an error if turnContext.getActor() returns null', async () => {
        ...
        expect(errorArg.message).toBe('EndTurnSuccessStrategy: No actor found in ITurnContext for END_TURN_SUCCESS. Cannot end turn.');
    });
