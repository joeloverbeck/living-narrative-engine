// Filename: src/tests/core/services/baseManifestItemLoader._storeItemInRegistry.test.js
...
describe('BaseManifestItemLoader._storeItemInRegistry', () => {
    ...
    beforeEach(() => {
        ...
        jest.clearAllMocks();
        // Re-assign mocks to the instance as clearAllMocks might affect them
