...
import {resolveOrder} from '../../../core/services/modLoadOrderResolver.js';
...
describe('T‑7 Comprehensive Matrix – failure paths', () => {
    ...
    it('cycle (two‑node A↔B) throws ModDependencyError', () => {
        ...
        expect(() => resolveOrder(requested, manifests, logger)).toThrow(ModDependencyError);
    });
