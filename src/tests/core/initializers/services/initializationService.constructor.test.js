...
import {tokens} from '../../../../core/config/tokens.js'; // Import tokens for DomUiFacade
            ...
            resolve: jest.fn((token) => {
                switch (token) {
                    ...
                    default:
                        ...
                        if (originalContainerResolve && originalContainerResolve.getMockImplementation()) {
                            const testImplementation = originalContainerResolve.getMockImplementation();
