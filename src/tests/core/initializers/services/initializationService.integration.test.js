...
import InitializationService from '../../../../core/initializers/services/initializationService.js'; // Adjust path if needed
import {registerOrchestration} from '../../../../core/config/registrations/orchestrationRegistrations.js'; // Function under test (partially)
