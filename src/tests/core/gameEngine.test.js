...
import {tokens} from '../../core/config/tokens.js'; // Assuming tokens are accessible for testing
import {
    GAME_LOADED_ID,
    GAME_SAVED_ID,
    NEW_GAME_STARTED_ID,
    ...
    GAME_STOPPED_ID
} from "../../core/constants/eventIds.js";
...
describe('GameEngine', () => {
    ...
    describe('loadGame', () => {
        ...
        it('should handle failure if loadAndRestoreGame returns success true but no data', async () => {
            ...
            const result = await gameEngine.loadGame(SAVE_ID);
            const expectedError = "Restored data was missing.";
