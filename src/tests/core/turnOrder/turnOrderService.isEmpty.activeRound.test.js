...
describe('TurnOrderService', () => {
    ...
    beforeEach(() => {
        ...
        initiativeData = new Map([['hero1', 20], ['monster1', 10]]);
        ...
        SimpleRoundRobinQueue.mockImplementation(() => {
            ...
            return /** @type {import('../../../core/turns/order/queues/simpleRoundRobinQueue.js').SimpleRoundRobinQueue} */ (mockSimpleQueueInstance);
        });
        ...
        InitiativePriorityQueue.mockImplementation(() => {
            ...
            // Ensure the mock function returns the created mock instance
            // Type assertion needed as mockImplementation signature is broad
            return /** @type {import('../../../core/turns/order/queues/initiativePriorityQueue.js').InitiativePriorityQueue} */ (mockInitiativeQueueInstance);
        });
    });
    ...
    describe('isEmpty (Active Round) [TEST-TURN-ORDER-001.11.7]', () => {
        ...
        it('Test Case 11.7.1: should delegate to Round Robin Queue isEmpty and return false when not empty', () => {
            ...
            expect(mockLogger.info).not.toHaveBeenCalledWith(expect.stringContaining('isEmpty'));
            expect(mockLogger.debug).not.toHaveBeenCalledWith(expect.stringContaining('isEmpty'));
