// src/tests/core/turnOrder/queues/initiativePriorityQueue.clear.test.js

/**
 * @fileoverview Unit tests for the InitiativePriorityQueue class, focusing on the clear() method.
