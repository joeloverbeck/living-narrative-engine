// src/tests/core/turnOrder/queues/initiativePriorityQueue.remove.test.js

/**
 * @fileoverview Unit tests for the InitiativePriorityQueue class, focusing on the remove() method (lazy removal).
...
describe('InitiativePriorityQueue', () => {
    ...
    describe('remove() Method Functionality (Lazy Removal)', () => {
        ...
        it('Test Case 11.5: should return null, log warning, and handle invalid IDs (empty string) gracefully', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith(expect.stringContaining('Attempted to remove entity with invalid ID ""'));
        ...
        it('Test Case 11.5b: should return null, log warning, and handle invalid IDs (null)', () => {
            ...
            expect(result).toBeNull();
            expect(consoleWarnSpy).toHaveBeenCalledTimes(1);
            expect(consoleWarnSpy).toHaveBeenCalledWith(expect.stringContaining('Attempted to remove entity with invalid ID "null"'));
        ...
        it('Test Case 11.5c: should return null, log warning, and handle invalid IDs (undefined)', () => {
            ...
            expect(result).toBeNull();
            expect(consoleWarnSpy).toHaveBeenCalledTimes(1);
            expect(consoleWarnSpy).toHaveBeenCalledWith(expect.stringContaining('Attempted to remove entity with invalid ID "undefined"'));
