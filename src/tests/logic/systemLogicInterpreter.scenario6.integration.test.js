...
const MOCK_RULE_CONTEXT_ACCESS = {
    ...
    actions: [{type: 'TEST_LOG_SUCCESS', parameters: {message: 'Context access successful!'}}]
};
...
describe('SystemLogicInterpreter - Integration Tests - Scenario 6: Context Access (Event Payload)', () => {
    ...
    beforeEach(() => {
        ...
        interpreter = new SystemLogicInterpreter({
            ...
            entityManager: mockEntityManager, operationInterpreter: operationInterpreterRealInstance
        });
    ...
    it('should execute action when event payload matches condition', () => {
        ...
        const expectedFlatCtx = createExpectedFlatJsonLogicContext(event, MOCK_ENTITY_FOR_EVENT, null);
        ...
        const expectedNestedCtx = createExpectedNestedContext(event, MOCK_ENTITY_FOR_EVENT, null, mockLogger);
