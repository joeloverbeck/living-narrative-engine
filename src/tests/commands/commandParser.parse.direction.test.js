...
import CommandParser from '../../core/commands/commandParser.js'; // Adjusted path to CommandParser
import {GameDataRepository} from '../../core/services/gameDataRepository.js'; // Adjusted path for GameDataRepository
...
jest.mock('../../core/services/gameDataRepository.js', () => { // Adjusted path for mocking
...
const MOCK_ACTIONS_DIRECTION_HANDLING = Object.freeze([
    ...
    {id: 'core:move', commandVerb: 'move', name: 'Move', target_domain: 'direction'},
    {id: 'core:put', commandVerb: 'put', name: 'Put', target_domain: 'item_on_surface'}, // Not 'direction'
    {id: 'core:examine', commandVerb: 'examine', name: 'Examine'}, // target_domain might be undefined or different
    {id: 'core:take', commandVerb: 'take', name: 'Take', target_domain: 'item_in_room'}, // Not 'direction'
    {id: 'core:look', commandVerb: 'look', name: 'Look', target_domain: 'general'} // Example, not 'direction'
]);
...
describe('CommandParser.parse() - Direction Handling Tests', () => {
    ...
    beforeEach(() => {
        ...
        mockGetAllActionDefinitions.mockReturnValue([...MOCK_ACTIONS_DIRECTION_HANDLING]);
