...
describe('ActionExecutor', () => {
  ...
  beforeEach(() => {
    ...
    mockGameDataRepository.getAction.mockReturnValue(mockActionDef); // Default action def
  });
    ...
    describe('context. Sources', () => {
      ...
      describe('context.currentLocation.id', () => {
        ...
        test('should log warn and return undefined if currentLocation is null', async () => {
          ...
          expect(mockValidatedDispatcher.dispatchValidated).toHaveBeenCalledWith(mockActionDef.dispatch_event.eventName, {});
        });
      });
