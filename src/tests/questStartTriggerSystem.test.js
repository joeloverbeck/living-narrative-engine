...
import { QuestLogComponent } from '../components/questLogComponent.js'; // Import real key if used
...
const questDefWithWrongLocation = { ...questDefWithCorrectTrigger, id: 'quest:wrong_loc', startingTriggers: [{ type: "on_enter_location", locationId: "demo:room_treasure" }] };
const questDefWithWrongType = { ...questDefWithCorrectTrigger, id: 'quest:wrong_type', startingTriggers: [{ type: "on_interact", entityId: "lever:xyz" }] };
...
const otherQuestDef = { id: 'quest:other', titleId: 'other_title', startingTriggers: [{ type: "on_event", eventName: "something_else" }] };
