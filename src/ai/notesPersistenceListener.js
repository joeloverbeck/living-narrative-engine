...
export class NotesPersistenceListener {
   ...
   *
   * @param {{ type: string, payload: { actorId: string, extractedData?: { notes?: Array<{text: string, subject: string, subjectType?: string, context?: string, timestamp?: string}> } } }} event -
