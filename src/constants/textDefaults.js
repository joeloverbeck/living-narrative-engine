...
export const DEFAULT_FALLBACK_ACTION_DESCRIPTION_RAW =
...
export const PROMPT_FALLBACK_UNKNOWN_LOCATION =
...
export const PROMPT_FALLBACK_NO_ACTIONS_NARRATIVE =
...
export const PROMPT_FALLBACK_UNKNOWN_CHARACTER_DETAILS =
  'Your character details are unknown.';
export const PROMPT_FALLBACK_ACTOR_PROMPT_DATA_UNAVAILABLE =
  "Your character's pre-processed details (actorPromptData) are unavailable. Using minimal info.";
export const PROMPT_FALLBACK_MINIMAL_CHARACTER_DETAILS =
  'Your character details are minimal or unknown.';

// --- AIPromptFormatter: Error Messages (typically fully punctuated) ---
export const ERROR_FALLBACK_CRITICAL_GAME_STATE_MISSING =
  'Error: Critical game state information is missing. Cannot generate LLM prompt.';
