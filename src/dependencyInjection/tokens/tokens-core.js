...
export const coreTokens = freeze({
  ...
  EffectDefinitionResolver: 'EffectDefinitionResolver',
  ...
  DepleteOxygenHandler: 'DepleteOxygenHandler',
  RestoreOxygenHandler: 'RestoreOxygenHandler',
  ...
  EatFromHandler: 'EatFromHandler',
  EatEntirelyHandler: 'EatEntirelyHandler',
  ...
  IGoapEventTraceProbe: 'IGoapEventTraceProbe',
  ...
  // Perception Entry Building Services (ADDPERLOGENTHANROB)
  IPerceptionEntryBuilder: 'IPerceptionEntryBuilder',
  ISensorialPropagationService: 'ISensorialPropagationService',
