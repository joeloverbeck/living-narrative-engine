 ...
 */
/**
 * @typedef {import('./IPlayerPromptService.js').IPlayerPromptService} IPlayerPromptService
...
export class ITurnContext {
    ...
    getCommandOutcomeInterpreter() {
        throw new Error("Method 'getCommandOutcomeInterpreter()' must be implemented.");
    }
