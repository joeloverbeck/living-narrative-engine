    ...
    async startTurn(actor) {
        ...
        if (!this._currentState) {
            ...
            if (fallbackInitialState) {
                ...
                if (!this._currentState) throw new Error("PlayerTurnHandler: _currentState is null, and recovery failed.");
            } else {
                throw new Error("PlayerTurnHandler: _currentState is null, and turnStateFactory failed to provide a state.");
            }
        }
