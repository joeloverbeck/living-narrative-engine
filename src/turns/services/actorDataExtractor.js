...
class ActorDataExtractor {
    ...
    extractPromptData(actorState) {
        ...
        promptData.name = (nameComponent && nameComponent.text && String(nameComponent.text).trim() !== '')
        ...
        const baseDescription = (descComponent && descComponent.text && String(descComponent.text).trim() !== '')
        ...
        for (const attr of optionalTextAttributes) {
            ...
            if (component && typeof component.text === 'string' && component.text.trim() !== '') {
        ...
        if (speechPatternsComponent && Array.isArray(speechPatternsComponent.patterns)) {
