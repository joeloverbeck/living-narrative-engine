...
export class ITurnState {
    ...
    async startTurn(handler, actorEntity) {
        throw new Error("ITurnState.startTurn must be implemented or is not applicable for this state.");
    }
    ...
    async handleSubmittedCommand(handler, commandString, actorEntity) {
        throw new Error("ITurnState.handleSubmittedCommand must be implemented or is not applicable.");
    }
    ...
    async handleTurnEndedEvent(handler, payload) {
        throw new Error("ITurnState.handleTurnEndedEvent must be implemented or is not applicable.");
    }
    ...
    async processCommandResult(handler, actor, cmdProcResult, commandString) {
        throw new Error("ITurnState.processCommandResult must be implemented or is not applicable.");
    }
    ...
    async handleDirective(handler, actor, directive, cmdProcResult) {
        throw new Error("ITurnState.handleDirective must be implemented or is not applicable.");
    }
