...
export class ITurnStateFactory {
    ...
    createInitialState(handler) {
        throw new Error("ITurnStateFactory.createInitialState must be implemented by concrete classes.");
    }
    ...
    createIdleState(handler) {
        throw new Error("ITurnStateFactory.createIdleState must be implemented by concrete classes.");
    }
    ...
    createEndingState(handler, actorId, error) {
        throw new Error("ITurnStateFactory.createEndingState must be implemented by concrete classes.");
    }
    ...
    createAwaitingInputState(handler) {
        throw new Error("ITurnStateFactory.createAwaitingInputState must be implemented by concrete classes.");
    }
}
