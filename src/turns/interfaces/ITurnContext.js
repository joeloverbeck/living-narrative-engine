...
export class ITurnContext {
   ...
   *
   * @param {{ speech:string|null, thoughts:string|null, notes:Array<{text: string, subject: string, context?: string, tags?: string[], timestamp?: string}>|null }|null} meta - The metadata object to store.
   * @returns {void}
   */
   ...
   *
   * @returns {{ speech:string|null, thoughts:string|null, notes:Array<{text: string, subject: string, context?: string, tags?: string[], timestamp?: string}>|null }|null} The stored metadata object.
   */
  getDecisionMeta() {
