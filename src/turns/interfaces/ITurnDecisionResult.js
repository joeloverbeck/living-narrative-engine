 ...
 * @property {{ speech:string|null, thoughts:string|null, notes:Array<{text: string, subject: string, context?: string, timestamp?: string}>|null, cognitiveLedger?: { settled_conclusions: string[], open_questions: string[] }|null }} extractedData
 */
