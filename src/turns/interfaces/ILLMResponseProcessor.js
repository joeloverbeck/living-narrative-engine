...
export class ILLMResponseProcessor {
     ...
     * @returns {ITurnAction} A valid ITurnAction derived from the LLM response,
     * or a fallback ITurnAction if processing fails.
     */
    processResponse(llmJsonResponse, actorId, logger) {
        ...
        throw new Error("Method 'processResponse(llmJsonResponse, actorId, logger)' must be implemented by concrete classes.");
    }
}
