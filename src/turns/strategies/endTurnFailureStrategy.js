...
export default class EndTurnFailureStrategy extends ITurnDirectiveStrategy {
    ...
    async execute(
        ...
        if (!contextActor) {
            ...
            logger.error(msg + " Ending turn with a generic error indicating missing actor.");
        ...
        logger.info(`${className}: Executing END_TURN_FAILURE for actor ${contextActor.id}. Error: ${turnEndError.message}`);
