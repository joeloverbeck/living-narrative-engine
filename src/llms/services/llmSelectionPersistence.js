...
export class LLMSelectionPersistence {
  ...
  static save(llmId) {
    ...
    try {
      ...
      console.warn('LLMSelectionPersistence: Failed to save LLM selection:', error);
      return false;
    }
  }
  ...
  static load() {
    try {
      ...
      console.warn('LLMSelectionPersistence: Failed to load LLM selection:', error);
      return null;
    }
  }
  ...
  static clear() {
    try {
      ...
      console.warn('LLMSelectionPersistence: Failed to clear LLM selection:', error);
      return false;
    }
  }
  ...
  static exists() {
    try {
      ...
      console.warn('LLMSelectionPersistence: Failed to check LLM selection existence:', error);
      return false;
    }
  }
}
