...
export function displayFatalStartupError(uiElements, errorDetails) {
    ...
    console.error(`[Bootstrapper Error - Phase: ${phase}] ${consoleMessage}`, errorObject || '');
    ...
    if (errorDiv && errorDiv instanceof HTMLElement) {
        try {
            ...
            console.error('displayFatalStartupError: Failed to set textContent on errorDiv.', e);
        }
    }
    ...
    if (!displayedInErrorDiv && outputDiv && outputDiv instanceof HTMLElement) {
        try {
            ...
            console.log('displayFatalStartupError: Displayed error in a dynamically created element near outputDiv.');
            displayedInErrorDiv = true; // Consider this as having displayed the error in a DOM element
        } catch (e) {
            console.error('displayFatalStartupError: Failed to create or append temporary error element.', e);
        }
    }
    ...
    if (!displayedInErrorDiv) {
        alert(userMessage);
        console.log('displayFatalStartupError: Displayed error using alert() as a fallback.');
    }
    ...
    if (titleElement && titleElement instanceof HTMLElement) {
        try {
            ...
            console.error('displayFatalStartupError: Failed to set textContent on titleElement.', e);
        }
    }
    ...
    if (inputElement && inputElement instanceof HTMLInputElement) {
        try {
            ...
            console.error('displayFatalStartupError: Failed to disable or set placeholder on inputElement.', e);
        }
    }
}