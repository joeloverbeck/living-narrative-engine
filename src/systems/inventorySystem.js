...
class InventorySystem {
    ...
    constructor({eventBus, entityManager, gameDataRepository, worldContext: worldContext}) {
        ...
        if (!worldContext) throw new Error('InventorySystem requires options.worldContext.');
