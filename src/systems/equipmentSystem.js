 ...
 * Listens for 'event:item_equip_attempted', 'event:item_unequip_attempted',
 * 'event:item_equipped', and 'event:item_unequipped'.
 */
class EquipmentSystem {
    ...
    initialize() {
        ...
        this.eventBus.subscribe('event:item_unequipped', this.handleItemUnequipped.bind(this)); // Keep for effect removal
    ...
    handleItemEquipAttempted(eventData) {
        ...
        try {
            ...
            console.log(`EquipmentSystem (Equip Attempt): Dispatched event:item_equipped for ${itemIdToEquip}.`);
        } catch (e) {
