...
class EquipmentSlotSystem {
  ...
  handleItemEquipAttempted(eventData) {
    ...
    if (!playerEntity || !itemInstanceToEquip || !targetSlotId) {
      ...
      this.#eventBus.dispatch('textUI:display_message', {text: TARGET_MESSAGES.INTERNAL_ERROR, type: 'error'});
      return;
    }
    ...
    if (!removedFromInv) {
      ...
      this.#eventBus.dispatch('textUI:display_message', {text: errorMsg, type: 'error'});
      return;
    }
    ...
    this.#eventBus.dispatch('textUI:display_message', {text: successMsg, type: 'success'});
