// src/services/actionFormatter.js

// --- Type Imports ---
/** @typedef {import('../types/actionDefinition.js').ActionDefinition} ActionDefinition */
/** @typedef {import('./actionValidationService.js').ActionTargetContext} ActionTargetContext */
 ...
 * @param {boolean} [options.debug=false] - If true, logs additional debug information.
