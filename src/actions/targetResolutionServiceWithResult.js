...
export class TargetResolutionServiceWithResult extends ITargetResolutionService {
  ...
  /**
   * Creates an instance of TargetResolutionServiceWithResult.
   *
  ...
  constructor({
    ...
    this.#logger = setup.setupService(
      'TargetResolutionServiceWithResult',
      logger,
      {
  ...
  resolveTargetsWithResult(
    ...
    const source = 'TargetResolutionServiceWithResult.resolveTargetsWithResult';
  ...
  #validateActorEntity(actorEntity, scopeName, trace, actionId) {
    const source = 'TargetResolutionServiceWithResult.#validateActorEntity';
  ...
  #resolveScopeToIds(
    ...
    const source = 'TargetResolutionServiceWithResult.#resolveScopeToIds';
...
export default TargetResolutionServiceWithResult;
