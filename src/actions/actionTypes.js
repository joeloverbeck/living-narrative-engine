 ...
 * @property {ActionMessage[]} [messages] - An array of messages intended for internal logging or debugging. Player-facing messages are typically handled via dispatched events (e.g., 'ui:message_display', EVENT_MOVE_FAILED). **NOTE:** Usage varies; some handlers still return messages. This might be refined later.
